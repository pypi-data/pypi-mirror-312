...
class CustomInstallCommand(install):
    def run(self):
        ...
        if system == "Windows":
            # Ruta del directorio de scripts para Windows
            ...
            # Ruta del directorio de scripts para Linux/macOS
        ...
        if scripts_dir:
            ...
            if scripts_dir not in path_env:
                if system == "Windows":
                    ...
                    self._add_to_shell_config(zshrc_path, scripts_dir)
                elif system == "Linux":
                    # Usar .bashrc en Linux
                    bashrc_path = os.path.expanduser("~/.bashrc")
                    self._add_to_shell_config(bashrc_path, scripts_dir)

        # Crear el directorio de configuración de paramsx
