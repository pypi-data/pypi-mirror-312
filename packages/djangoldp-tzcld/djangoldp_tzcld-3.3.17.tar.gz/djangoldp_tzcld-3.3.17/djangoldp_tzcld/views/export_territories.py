            ...
            for urlid in request.data:
                ...
                if validators.url(urlid):
                    ...
                    if instance:
                        ...
                        territories_political_landscape_deputies = getattr(tzcld_profile_identity, "territories_political_landscape_deputies", None)
                        territories_political_landscape_senators = getattr(tzcld_profile_identity, "territories_political_landscape_senators", None)
