...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, pulp_created=None, pulp_labels=None, name=None, hidden=False, pulp_href=None, base_url=None, base_path=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
