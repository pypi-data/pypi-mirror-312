...
class PlateBendingKirchhoffClass:
    ...
    def Construct_Loadvector(self):
        ...
        if (self.loading == "Regular"):
            ...
            self.RectangularLoad = pd.DataFrame(pd.read_csv("Loading/Constant_Loading.csv"))
