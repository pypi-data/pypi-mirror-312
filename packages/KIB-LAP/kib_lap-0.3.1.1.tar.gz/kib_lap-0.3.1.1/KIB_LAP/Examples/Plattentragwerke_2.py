...
Plate = PlateBendingKirchhoffClass(
    35000, 0.35, a, b, 1, 0.5, 0.5, 0.5, 0.5, 0.0, 0, 0, 0, "Regular", "hhhh",2
)

# Lasteingabe schreiben
...
# df = pd.DataFrame({"P": Plate.load.round(4)})
# df.to_csv("Ergebnisse/GelenkigPlatte/GelenkigPlatte_Teilflaeche_Lastvektor_LS1.csv",index_label='Index')