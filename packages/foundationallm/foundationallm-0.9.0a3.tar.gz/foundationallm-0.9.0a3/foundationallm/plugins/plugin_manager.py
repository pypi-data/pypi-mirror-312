...
class PluginManager():
        ...
        if valid_configuration:
            ...
            try:
                ...
                for module_configuration in [x.split('|') for x in modules_list.split(',')]:
                    ...
                    module_version = module_configuration[1]
    ...
    def load_external_modules(self):
        ...
        for module_name in self.external_modules.keys():
            ...
            module_configuration = self.external_modules[module_name]
            module_file_name = f'{module_configuration.module_name}-{module_configuration.module_version}.zip'
            ...
            try:
                ...
                module_configuration.module = import_module(module_configuration.module_name)

                self.logger.info(f'Module {module_name} loaded successfully.')
                module_configuration.module_loaded = True

                # Note the () at the end of the getattr call - this is to call the class constructor, not just get the class.
                module_configuration.tool_plugin_manager = getattr(module_configuration.module, module_configuration.tool_plugin_manager_class_name)()
