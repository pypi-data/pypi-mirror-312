...
class GetImageOcclusionNoteResponse(google.protobuf.message.Message):
    ...
    class ImageOcclusionNote(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["back_extra", b"back_extra", "header", b"header", "image_data", b"image_data", "image_file_name", b"image_file_name", "occlusions", b"occlusions", "tags", b"tags"]) -> None: ...
