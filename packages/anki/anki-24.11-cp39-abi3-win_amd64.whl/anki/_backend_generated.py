...
class RustBackendGenerated:
 ...
 if the backup encountered an error."""
    ...
    def compute_fsrs_params(self, *, search: str, current_params: Iterable[float], ignore_revlogs_before_ms: int) -> anki.scheduler_pb2.ComputeFsrsParamsResponse:
        message = anki.scheduler_pb2.ComputeFsrsParamsRequest(search=search, current_params=current_params, ignore_revlogs_before_ms=ignore_revlogs_before_ms)
    ...
    def simulate_fsrs_review(self, *, params: Iterable[float], desired_retention: float, deck_size: int, days_to_simulate: int, new_limit: int, review_limit: int, max_interval: int, search: str) -> anki.scheduler_pb2.SimulateFsrsReviewResponse:
        message = anki.scheduler_pb2.SimulateFsrsReviewRequest(params=params, desired_retention=desired_retention, deck_size=deck_size, days_to_simulate=days_to_simulate, new_limit=new_limit, review_limit=review_limit, max_interval=max_interval, search=search)
