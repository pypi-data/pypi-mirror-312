...
class DataTableNode:
    ...
    Attributes:
        ...
        is_empty (Union[Unset, bool]): Whether or not there is any meaningful data that can be entered into this table
            or in tables in this folder.
        children (Union[List['DataTableNode'], None, Unset]):
    """
    ...
    children: Union[List["DataTableNode"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_children(data: object) -> Union[List["DataTableNode"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[List["DataTableNode"], None, Unset], data)
