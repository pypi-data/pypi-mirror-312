...
class ResultTableNodeArrayResponse:
    ...
    Attributes:
        ...
        result (Union[List['ResultTableNode'], None, Unset]):
    """

    messages: Union[List["Message"], None, Unset] = UNSET
    result: Union[List["ResultTableNode"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_result(data: object) -> Union[List["ResultTableNode"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
