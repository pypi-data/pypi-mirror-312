...
class ModelArrayResponse:
    ...
    Attributes:
        ...
        result (Union[List['Model'], None, Unset]):
    """

    messages: Union[List["Message"], None, Unset] = UNSET
    result: Union[List["Model"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_result(data: object) -> Union[List["Model"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[List["Model"], None, Unset], data)
