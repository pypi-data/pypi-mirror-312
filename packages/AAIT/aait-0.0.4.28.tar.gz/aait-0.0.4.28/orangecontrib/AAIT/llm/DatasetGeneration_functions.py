...
Tu vas recevoir un extrait de document sur lequel tu devras générer des paires de questions/réponses pertinentes et autonomes, sans faire référence explicite au document.


### Instructions :
- Génère des questions et les réponses associées qui reflètent les informations principales de l'extrait fourni.
- Le document doit permettre de répondre à la question : ne génère pas de question sur les informations incomplètes.
- Les questions doivent être formulées de manière autonome, sans mentionner le document ou faire référence à sa source.
...
# theme = "Le manuel de service de l'hélicoptère FAMA Jetcopter K209M / MF."
# folder = r"C:\Users\lucas\Desktop\HelicoFinetuning_json"
# for filename in os.listdir(folder):
#     if filename.endswith(".json") and "Owners Manuel Fama Kiss_questions_chunk" in filename:
#         filepath = os.path.join(folder, filename)
#         transform_and_save(filepath, theme)
