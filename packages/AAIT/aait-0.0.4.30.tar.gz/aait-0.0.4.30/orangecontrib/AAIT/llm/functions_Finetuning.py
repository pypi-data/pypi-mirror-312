...
model = Llama(r"C:\Users\lucas\aait_store\Models\NLP\chocolatinoptere.gguf", n_ctx=4096, n_gpu_layers=-1, verbose=False)
request = f"<|system|>\n\n<|end|>\n<|user|>\nPour l'hélicoptère FAMA K209M, quelles sont les caractéristiques du rotor principal ?\n<|end|>\n<|assistant|>"

print(model(request, max_tokens=700)["choices"][0]["text"])
