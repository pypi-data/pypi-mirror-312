...
class OWModelSolarUncensored(widget.OWWidget):
    name = "LlmSolar7B Uncensored"
    description = "Load the LLM model Solar Uncensored from the AAIT Store"
    ...
    class Outputs:
        model = Output("Model", str, auto_summary=False)
    ...
    def __init__(self):
        ...
        if not os.path.exists(model_path):
            ...
            try:
                ...
                return
        self.Outputs.model.send(model_name)
