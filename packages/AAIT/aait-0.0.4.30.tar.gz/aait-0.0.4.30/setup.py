...
VERSION = "0.0.4.30"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
PACKAGES = [pack for pack in PACKAGES if "orangecontrib" in pack and not "OWInterface" in pack]
print(PACKAGES)
