...
class LinkModelDataSet:
    ...
    def __init__(self, **kwargs):
        ...
        if self.__category == GENERIC_CLASSIFICATION:
            print("User can create new features for this dataset. For this you can use 'feature_interaction' method for this")
    ...
    def feature_interaction(self, dict):
        ...
        example = {'product': "{'feature1': feature1, 'feature2': feature2, 'method':product}",
        ...
        print(f"The feature list is {feature_list}")
        print(f"The method options are: {method_list}")
        print(f"The example for each method use are: {example}")
