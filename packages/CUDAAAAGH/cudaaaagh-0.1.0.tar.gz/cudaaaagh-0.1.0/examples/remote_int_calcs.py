from CUDAAAAGH import RemoteInt, set_compute_endpoint, sha256
...
def main():
    ...
    # Bitwise operations
    print("\n=== Bitwise Operations ===")
    x = RemoteInt(12)  # 1100 in binary
    y = RemoteInt(10)  # 1010 in binary
    ...
    hash_result = sha256(message, RemoteInt)
