...
class Drives(BaseSDK):
    def list(
        ...
        *,
        request: Union[
            ...
            models.FileStorageDrivesAllRequestTypedDict,
        ] = models.FileStorageDrivesAllRequest(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.FileStorageDrivesAllResponse:
        r"""List Drives
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.FileStorageDrivesAllRequest)
        request = cast(models.FileStorageDrivesAllRequest, request)
    ...
    def create(
        self,
        *,
        drive: Union[models.DriveInput, models.DriveInputTypedDict],
        ...
        request = models.FileStorageDrivesAddRequest(
            ...
            drive=utils.get_pydantic_model(drive, models.DriveInput),
        )
