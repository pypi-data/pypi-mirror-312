...
class Products(BaseSDK):
    def list(
        ...
        *,
        request: Union[
            models.EcommerceProductsAllRequest,
            models.EcommerceProductsAllRequestTypedDict,
        ] = models.EcommerceProductsAllRequest(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.EcommerceProductsAllResponse:
        r"""List Products
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.EcommerceProductsAllRequest)
        request = cast(models.EcommerceProductsAllRequest, request)
