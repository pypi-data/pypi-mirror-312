...
class Orders(BaseSDK):
    def list(
        ...
        *,
        request: Union[
            models.EcommerceOrdersAllRequest, models.EcommerceOrdersAllRequestTypedDict
        ] = models.EcommerceOrdersAllRequest(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.EcommerceOrdersAllResponse:
        r"""List Orders
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.EcommerceOrdersAllRequest)
        request = cast(models.EcommerceOrdersAllRequest, request)
