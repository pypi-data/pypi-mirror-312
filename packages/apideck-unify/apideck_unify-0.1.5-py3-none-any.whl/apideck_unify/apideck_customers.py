...
class ApideckCustomers(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> models.EcommerceCustomersAllResponse:
        r"""List Customers
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.EcommerceCustomersAllRequest)
        request = cast(models.EcommerceCustomersAllRequest, request)
