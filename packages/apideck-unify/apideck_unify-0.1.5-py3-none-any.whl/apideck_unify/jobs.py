...
class Jobs(BaseSDK):
    def list(
        ...
        *,
        request: Union[
            models.AtsJobsAllRequest, models.AtsJobsAllRequestTypedDict
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.AtsJobsAllRequest)
        request = cast(models.AtsJobsAllRequest, request)
