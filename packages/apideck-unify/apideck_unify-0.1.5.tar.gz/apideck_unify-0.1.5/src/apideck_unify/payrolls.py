...
class Payrolls(BaseSDK):
    def list(
        ...
        *,
        request: Union[
            models.HrisPayrollsAllRequest, models.HrisPayrollsAllRequestTypedDict
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.HrisPayrollsAllRequest)
        request = cast(models.HrisPayrollsAllRequest, request)
