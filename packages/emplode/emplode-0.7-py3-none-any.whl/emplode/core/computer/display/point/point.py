...
from .....terminal_interface.utils.em_dir import em_dir
...
def find_icon(description, screenshot=None, debug=False, hashes=None):
    ...
    debug_path = os.path.join(os.path.expanduser("~"), "Desktop", "em-debug")
    ...
    # Filter out extremes
    min_icon_width = int(os.getenv("EM_POINT_MIN_ICON_WIDTH", "10"))
    max_icon_width = int(os.getenv("EM_POINT_MAX_ICON_WIDTH", "500"))
    min_icon_height = int(os.getenv("EM_POINT_MIN_ICON_HEIGHT", "10"))
    max_icon_height = int(os.getenv("EM_POINT_MAX_ICON_HEIGHT", "500"))
    ...
    pixel_expand = int(os.getenv("EM_POINT_PIXEL_EXPAND", 7))
    ...
    if os.getenv("EM_POINT_OVERLAP", "True") == "True":
...
def get_element_boxes(image_data, debug):
    ...
    debug_path = os.path.join(desktop_path, "em-debug")
    ...
    if os.getenv("EM_POINT_PERMUTATE", "False") == "True":
        import random
