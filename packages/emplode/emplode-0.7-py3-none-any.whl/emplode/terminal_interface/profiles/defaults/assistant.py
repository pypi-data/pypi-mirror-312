...
try:
    ...
    print(
        "Some actions may fail as OS dependencies are not installed. Please run 'pip install emplode[os]' to install them."
    )
...
emplode.computer.skills.path = "./skills"

# Extra settings
emplode.computer.import_computer_api = True
emplode.computer.import_skills = True
emplode.computer.run("python", "computer")  # This will trigger those imports
...
# Final message
emplode.display_message("> Assistant mode enabled")
