...
if missing_packages:
    print(
        '{} isn\'t installed. Please run `pip install "emplode[os]"` to install all required packages for OS mode'.format(
...
emplode.display_message(
    "\n**Note:** Codestral is a relatively weak model, so OS mode is highly experimental. Try using a more powerful model for OS mode with `emplode --os`."
)
emplode.display_message("> Experimental OS control enabled.")
