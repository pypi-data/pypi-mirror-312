...
def conversation_navigator(emplode):
    import time
    ...
    # Set the emplode's settings to the loaded messages
    emplode.messages = messages
    emplode.conversation_filename = selected_filename
