...
class TNConvergenceParameters(_ParameterizedClass):
    ...
    **Arguments**
    ...
    skip_exact_rgtensors : logical, optional
        ...
        [py-only: filter before the sweep applied; avoids even isometrizing
        towards the skipped tensors.]
        [f90-only: Only applies to sweep with space expansion.]
        Default to False.
    ...
    min_expansion : int, optional
        ...
        In Python it is also used when doing an expanding QR,
        in which case the value is the percentage increase.
        Default to 20.
    ...
    def __init__(
        ...
        if n_points_conv_check < 2:
            raise ValueError("Minumum number of points for convergence is 2")
