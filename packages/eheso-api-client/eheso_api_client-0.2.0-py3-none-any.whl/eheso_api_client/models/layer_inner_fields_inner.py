...
class LayerInnerFieldsInner(BaseModel):
    """
    LayerInnerFieldsInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LayerInnerFieldsInner:
        """Create an instance of LayerInnerFieldsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LayerInnerFieldsInner:
        """Create an instance of LayerInnerFieldsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LayerInnerFieldsInner.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LayerInnerFieldsInner) in the input: " + obj)

        _obj = LayerInnerFieldsInner.parse_obj({
