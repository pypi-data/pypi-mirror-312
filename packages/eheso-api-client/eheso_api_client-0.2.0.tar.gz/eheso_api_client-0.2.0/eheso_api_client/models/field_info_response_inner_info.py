...
class FieldInfoResponseInnerInfo(BaseModel):
    """
    FieldInfoResponseInnerInfo
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FieldInfoResponseInnerInfo:
        """Create an instance of FieldInfoResponseInnerInfo from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FieldInfoResponseInnerInfo:
        """Create an instance of FieldInfoResponseInnerInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FieldInfoResponseInnerInfo.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in FieldInfoResponseInnerInfo) in the input: " + obj)

        _obj = FieldInfoResponseInnerInfo.parse_obj({
