...
from eheso_api_client.models.layer_inner_country_config import LayerInnerCountryConfig
from eheso_api_client.models.layer_inner_fields_inner import LayerInnerFieldsInner

class LayerInner(BaseModel):
    """
    LayerInner
    """
    country_config: Optional[LayerInnerCountryConfig] = Field(default=None, alias="countryConfig")
    ...
    fields: Optional[conlist(LayerInnerFieldsInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LayerInner:
        """Create an instance of LayerInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LayerInner:
        """Create an instance of LayerInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LayerInner.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LayerInner) in the input: " + obj)

        _obj = LayerInner.parse_obj({
            "country_config": LayerInnerCountryConfig.from_dict(obj.get("countryConfig")) if obj.get("countryConfig") is not None else None,
            ...
            "fields": [LayerInnerFieldsInner.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None,
