...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('plotrates', 'display', 'residuals', 'mat', 'pre', 'callback', 'printrates', 'clear_output', 'sol', 'tol', 'ress', 'its', 'ax', 'maxiter', 'fig', 'iterations', 'atol', 'callback_sol', 'plt', '_final_residual')
