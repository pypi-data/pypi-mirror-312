...
from .exceptions import AssonantComponentFactoryError, AssonantDataHandlerFactoryError
...
class AssonantComponentFactory:
    ...
    def create_component_by_class_name(class_name: str, component_name: str) -> Component:
        ...
        try:
            ...
            raise AssonantComponentFactoryError(
                f"Error ocurred when creating Assonant Component by the following class name: {class_name}"
            ) from e
        return component
    ...
    def create_component_by_class_type(class_type: Component, component_name: str) -> Component:
        ...
        try:
            ...
            raise AssonantComponentFactoryError(
                f"Error ocurred when creating Assonant Component by the following class type: {class_type}"
            ) from e
        return component
