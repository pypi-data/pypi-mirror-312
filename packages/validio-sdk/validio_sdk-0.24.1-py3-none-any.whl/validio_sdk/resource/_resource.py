...
class Resource(Diffable):
    ...
    async def _api_delete(self, client: APIClient) -> Any:
        """Api method to delete this resource."""
        method_name = self._api_delete_method_name()
        arguments = self._api_delete_arguments()
        delete_input = self._api_delete_input()
    ...
    async def _api_create_or_update(
        self, verb: str, client: APIClient, api_input: Any | None
    ) -> Any:
        if verb == "create":
