...
async def upload_artifacts(
    ...
    """
    upload_id = await client.dbt_artifact_multipart_upload_create(
    ...
    for i in range(num_chunks):
        ...
        await client.dbt_artifact_multipart_upload_append_part(
            upload_id=upload_id,
            part=part,
        )

    await client.dbt_artifact_multipart_upload_complete(upload_id=upload_id)
