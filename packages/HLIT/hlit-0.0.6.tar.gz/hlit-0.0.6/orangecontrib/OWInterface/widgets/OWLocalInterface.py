...
from Orange.widgets.orangecontrib.OWInterface.download.BaseLocalInterfaceWidget import BaseLocalInterfaceWidget


class OWLocalInterface(BaseLocalInterfaceWidget):
    ...
    def process_files(self, files_to_process: list[Path]):
        ...
        try:
            ...
            print(f"Data loaded successfully for workflow {self.workflow_id} and file {self.input_id}")
