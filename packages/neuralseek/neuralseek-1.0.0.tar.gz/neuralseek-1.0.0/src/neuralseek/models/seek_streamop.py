...
from .seek_response import SeekResponse, SeekResponseTypedDict
...
class SeekStreamMetadataTypedDict(TypedDict):
    user_id: NotRequired[str]
    r"""A unique user identifier."""


class SeekStreamMetadata(BaseModel):
    user_id: Optional[str] = ""
    r"""A unique user identifier."""


class SeekStreamSystemTypedDict(TypedDict):
    session_id: NotRequired[str]
    r"""A session identifier for the defined user."""


class SeekStreamSystem(BaseModel):
    session_id: Optional[str] = ""
    r"""A session identifier for the defined user."""


class SeekStreamUserSessionTypedDict(TypedDict):
    r"""Context tracking object. You must set at least one of user_id or session_id to enable context keeping."""

    metadata: NotRequired[SeekStreamMetadataTypedDict]
    system: NotRequired[SeekStreamSystemTypedDict]


class SeekStreamUserSession(BaseModel):
    r"""Context tracking object. You must set at least one of user_id or session_id to enable context keeping."""

    metadata: Optional[SeekStreamMetadata] = None

    system: Optional[SeekStreamSystem] = None


class SeekStreamParamsTypedDict(TypedDict):
...
class SeekStreamParams(BaseModel):
    name: Optional[str] = ""
    r"""The parameter name"""
...
class SeekStreamPersonalizeTypedDict(TypedDict):
...
class SeekStreamPersonalize(BaseModel):
    r"""An object that allows NeuralSeek to tailor a response for a specific user"""
...
class SeekStreamLastTurnTypedDict(TypedDict):
...
class SeekStreamLastTurn(BaseModel):
    input: Optional[str] = ""
    r"""The user input"""
...
class SeekStreamOptionsTypedDict(TypedDict):
    r"""Optional object for runtime override of Seek options."""

    personalize: NotRequired[SeekStreamPersonalizeTypedDict]
    r"""An object that allows NeuralSeek to tailor a response for a specific user"""
    ...
    last_turn: NotRequired[List[SeekStreamLastTurnTypedDict]]
...
class SeekStreamOptions(BaseModel):
    r"""Optional object for runtime override of Seek options."""

    personalize: Optional[SeekStreamPersonalize] = None
    r"""An object that allows NeuralSeek to tailor a response for a specific user"""
    ...
    last_turn: Annotated[
        Optional[List[SeekStreamLastTurn]], pydantic.Field(alias="lastTurn")
    ] = None
    r"""lastTurn is a flexible object. It is backwards compatible with the original single turn object, as well as compatible with the Watson Assistant session history format."""
...
class SeekStreamRequestBodyTypedDict(TypedDict):
    r"""The request object.  Must include the question and a context."""

    question: NotRequired[str]
    r"""The user's question for NeuralSeek"""
    user_session: NotRequired[SeekStreamUserSessionTypedDict]
    r"""Context tracking object. You must set at least one of user_id or session_id to enable context keeping."""
    params: NotRequired[List[SeekStreamParamsTypedDict]]
    r"""An array of parameters to use in evaluation of the seek when calling mAIstro during a seek."""
    options: NotRequired[SeekStreamOptionsTypedDict]
    r"""Optional object for runtime override of Seek options."""


class SeekStreamRequestBody(BaseModel):
    r"""The request object.  Must include the question and a context."""

    question: Optional[str] = ""
    r"""The user's question for NeuralSeek"""

    user_session: Optional[SeekStreamUserSession] = None
    r"""Context tracking object. You must set at least one of user_id or session_id to enable context keeping."""

    params: Optional[List[SeekStreamParams]] = None
    r"""An array of parameters to use in evaluation of the seek when calling mAIstro during a seek."""

    options: Optional[SeekStreamOptions] = None
    r"""Optional object for runtime override of Seek options."""


class SeekStreamResponseBodyTypedDict(TypedDict):
    r"""Answer response"""

    data: SeekResponseTypedDict


class SeekStreamResponseBody(BaseModel):
    r"""Answer response"""
