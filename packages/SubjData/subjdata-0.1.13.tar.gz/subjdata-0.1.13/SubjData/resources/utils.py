...
def load_overview(overview_name):
    ...
    if overview_name == 'original':
        with importlib.resources.open_text('SubjData.resources', 'overview_dict_original.json') as file:
...
def load_mapping(mapping_name):
    ...
    if mapping_name == 'original':
        with importlib.resources.open_text('SubjData.resources', 'mapping_original.json') as file:
...
def load_taxonomy(taxonomy_name):
    ...
    if taxonomy_name == 'original':
        with importlib.resources.open_text('SubjData.resources', 'taxonomy_original.json') as file:
