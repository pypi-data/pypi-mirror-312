...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Enable mock mode")
    parser.add_argument("--mock-mode", action="store_true", help="Enable mock mode")
    parser.add_argument("--save-tmp", action="store_true", help="Save temporary crawled files. Use --output option to specify destination (working dir by default).")
    parser.add_argument("--output", action="store", default='./', help="Directory for saving crawled temporary files. Default: current working directory will be used.")
    parser.add_argument('--input-dir', action="store", type=str, help='Directory for input files.')
    parser.add_argument("-k", dest='parser_names', action="append", default=None, help="Filter by parser name.")
