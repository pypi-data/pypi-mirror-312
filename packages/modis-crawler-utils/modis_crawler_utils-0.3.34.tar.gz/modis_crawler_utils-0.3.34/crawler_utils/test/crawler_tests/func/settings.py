...
arguments_data = load_json_data(Path(DIR_TO_PROJECT) / 'crawler_arguments.json')
spiders_specification = load_json_data(Path(DIR_TO_PROJECT) / 'spiders_specification.json')
...
def configure_crawler_settings(parser_name, tmp_dir: Path, mock_mode_enabled=False):
    """
    ...
    if mock_mode_enabled:
        ...
        cache_dir: Path = BASE_DIR/'cache_response'/parser_name
