...
requirements = ['Click>=7.0', "edn_format", "pydantic", "pyparsing"]
...
setup(
    ...
    # long_description_content_type='text/markdown',
        packages=find_packages(include=["shadowprover.fol", "shadowprover.experimental", "shadowprover.syntax", "shadowprover.unifiers"]) , # Automatically find packages
