...
def fol_prove(inputs, output, find_answer=False, verbose=False, max_answers=5, e_prover_invocation="./eprover"):
    tptp_inputs = [
    ...
    input_spec = "\n".join(tptp_inputs) + "\n" + tptp_output
    completed_process = run_eprover_with_string_input(input_spec,find_answer, max_answers, e_prover_invocation=e_prover_invocation)
