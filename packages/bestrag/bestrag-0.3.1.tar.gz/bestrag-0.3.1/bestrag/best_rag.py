...
class BestRAG:
    ...
    def store_pdf_embeddings(self, pdf_path: str,
        ...
        for page_num, text in enumerate(texts):
            ...
            print(f"Stored embedding for page {\
                  page_num + 1} of '{pdf_name}' in collection '{self.collection_name}'.")
    ...
    def delete_pdf_embeddings(self, pdf_name: str):
        ...
        print(f"Deleted all embeddings for PDF '{\
              pdf_name}' from collection '{self.collection_name}'.")
