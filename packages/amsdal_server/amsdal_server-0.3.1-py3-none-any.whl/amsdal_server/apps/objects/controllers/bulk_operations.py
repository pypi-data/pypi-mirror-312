...
async def object_bulk_update(
    ...
    *,
    ...
    return ObjectApi.bulk_update_objects(  # type: ignore[call-arg]
        request.user,
        base_url=str(request.base_url),
        data=data,
        load_references=load_references,
...
async def object_bulk_partial_update(
    ...
    *,
    ...
    return ObjectApi.bulk_partial_update_objects(  # type: ignore[call-arg]
        request.user,
        base_url=str(request.base_url),
        data=data,
        load_references=load_references,
...
async def object_bulk_delete(
    ...
    *,
    ...
    ObjectApi.bulk_delete_objects(request.user, data=data)  # type: ignore[call-arg]
