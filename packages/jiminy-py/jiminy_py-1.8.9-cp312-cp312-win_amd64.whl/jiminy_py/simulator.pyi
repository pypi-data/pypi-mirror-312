...
class Simulator:
    ...
    @classmethod
    def build(cls, urdf_path: str, hardware_path: str | None = None, mesh_path_dir: str | None = None, has_freeflyer: bool = True, config_path: str | None = None, avoid_instable_collisions: bool = True, debug: bool = False, *, name: str = '', **kwargs: Any) -> Simulator: ...
