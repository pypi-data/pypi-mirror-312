...
def extract_google_takeout_seed(landing_bucket_name: str, landing_prefix: str) -> None:
...
def main() -> None:  # noqa: D103
    ...
    extract_google_takeout_seed(args.landing_bucket_name, args.landing_prefix)
