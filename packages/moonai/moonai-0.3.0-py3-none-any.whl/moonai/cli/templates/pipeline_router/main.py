#!/usr/bin/env python
import asyncio
from moonai.routers.router import Route
    ...
    inputs = [
       {
        "email": """
            ...
            Please prioritize this campaign above all other missions. I'll be available for the next 24 hours to address any concerns or roadblocks.
