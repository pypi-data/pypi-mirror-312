...
from moonai.cli.authentication.utils import TokenManager
...
def _get_project_attribute(
    ...
    try:
        ...
        if not any(True for dep in dependencies if "moonai" in dep):
            raise Exception("moonai is not in the dependencies.")
...
def get_moonai_version() -> str:
    """Get the version number of moonai running the CLI"""
    return importlib.metadata.version("moonai")
