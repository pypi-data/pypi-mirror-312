...
from moonai.memory.storage.interface import Storage
...
class Mem0Storage(Storage):
    ...
    def __init__(self, type, squad=None):
        super().__init__()
        ...
        self.squad = squad
        self.memory_config = squad.memory_config
    ...
    def search(
        ...
        # automatically when the squad is created.
    ...
    def _get_agent_name(self):
        agents = self.squad.agents if self.squad else []
