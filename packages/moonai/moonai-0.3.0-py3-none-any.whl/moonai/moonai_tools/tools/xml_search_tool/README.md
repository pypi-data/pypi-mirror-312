...
## Installation
To start using the XMLSearchTool, you must first install the moonai.moonai_tools package. This can be easily done with the following command:
...
```python
from moonai.moonai_tools.tools.xml_search_tool import XMLSearchTool
