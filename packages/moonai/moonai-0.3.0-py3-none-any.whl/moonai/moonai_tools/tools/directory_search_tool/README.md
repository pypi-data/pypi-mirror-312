...
## Installation
To start using the DirectorySearchTool, you need to install the moonai.moonai_tools package. Execute the following command in your terminal:
...
```python
from moonai.moonai_tools import DirectorySearchTool
