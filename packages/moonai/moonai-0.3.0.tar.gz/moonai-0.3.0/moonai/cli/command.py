...
from moonai.cli.plus_api import PlusAPI
from moonai.cli.utils import get_auth_token
...
class PlusAPIMixin:
    def __init__(self, telemetry):
        try:
            ...
            console.print(
                "Please sign up/login to moonai+ before using the CLI.",
                style="bold red",
            )
            console.print("Run 'moonai signup' to sign up/login.", style="bold green")
            raise SystemExit
