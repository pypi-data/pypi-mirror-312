...
from darfix.gui.data_selection.edf import (
    EDFDatasetSelectionWidget,
)
...
class EDFDataSelectionWidgetOW(
    OWDarfixWidgetOneThread, ewokstaskclass=EDFDataSelection
):
    """
