...
from darfix.core.datapathfinder import DETECTOR_KEYWORD, SCAN_KEYWORD
from darfix.tasks.hdf5_scans_concatenation import (
    ConcatenateHDF5Scans,
    guess_output_file,
)
from darfix.gui.data_selection.hdf5 import HDF5DatasetSelectionWidget
from darfix.gui.configuration.action import (
    RequiredConfigurationAction,
    AdvancedConfigurationAction,
)
...
class HDF5ConcatenateWindow(qt.QMainWindow):
    ...
    def __init__(self, parent: qt.QWidget | None = None) -> None:
        ...
        self._requiredConfigAction.setChecked(True)
        self._userModeChanged(self._requiredConfigAction)
...
class ConcatenateScansWidget(HDF5DatasetSelectionWidget):
    ...
    def setConfigurationLevel(self, level: ConfigurationLevel | str):
        super().setConfigurationLevel(level=level)
