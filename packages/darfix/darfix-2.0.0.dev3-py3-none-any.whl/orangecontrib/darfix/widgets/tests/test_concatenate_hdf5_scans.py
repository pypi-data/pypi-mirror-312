...
from darfix.tasks.tests.test_hdf5_scans_concatenation import create_scans
...
def test_ConcatenateWidgetOW(tmp_path, qtapp):  # noqa F811
    ...
    Define inputs from the GUI and process to the concatenation.
    Make sure the expected output file exists (but doesn't check the content. This is part of the ewoks task to check this)).
    """
