...
from dtaianomaly.preprocessing.Preprocessor import Preprocessor, check_preprocessing_inputs
...
class ChainedPreprocessor(Preprocessor):
    ...
    def __init__(self, *base_preprocessors: Union[Preprocessor, List[Preprocessor]]):
        ...
        if not utils.is_valid_list(base_preprocessors, Preprocessor) or len(base_preprocessors) == 0:
