...
from allennlp_srl_bert.common.checks import log_pytorch_version_info
...
def group_by_count(
    ...
    """
    return [
        list(x) for x in zip_longest(*[iter(iterable)] * count, fillvalue=default_value)
    ]
...
def import_module_and_submodules(
    ...
    try:
        ...
        exclude |= {"srl_bert.confidence_checks.task_checklists"}
    ...
    with push_python_path("."):
        ...
        for module_finder, name, _ in pkgutil.walk_packages(path):
            ...
            if name.startswith("test"):
                # as long as srl_bert.common.testing is not under tests/, exclude it
                continue
