"""
`srl_bert.common.registrable.Registrable` is a "mixin" for endowing
...
from allennlp_srl_bert.common.from_params import FromParams
    ...
    def _to_params(self) -> Dict[str, Any]:
        ...
        for parameter in inspect.signature(self.__class__).parameters.values():
            ...
            if hasattr(self, parameter.name):
                ...
                logger.warning(
                    f"Could not find a value for positional argument {parameter.name}"
                )
                continue
