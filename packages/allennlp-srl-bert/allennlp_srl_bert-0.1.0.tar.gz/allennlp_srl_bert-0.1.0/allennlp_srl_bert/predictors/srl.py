...
from allennlp_srl_bert.common.util import JsonDict, sanitize, group_by_count
from allennlp_srl_bert.data import DatasetReader, Instance
from allennlp_srl_bert.data.tokenizers.spacy_tokenizer import SpacyTokenizer
...
class SemanticRoleLabelerPredictor(Predictor):
    ...
    def tokens_to_instances(self, tokens):
        ...
        for i, word in enumerate(tokens):
            ...
            if word.pos_ == "VERB" or (
                self._language.startswith("en_") and word.pos_ == "AUX"
            ):
