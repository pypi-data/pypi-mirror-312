...
from allennlp_srl_bert.common import Registrable, plugins
from allennlp_srl_bert.common.util import JsonDict, sanitize
from allennlp_srl_bert.data import DatasetReader, Instance
from allennlp_srl_bert.data.batch import Batch
from allennlp_srl_bert.models import Model
from allennlp_srl_bert.models.archival import Archive, load_archive
...
class Predictor(Registrable):
    ...
    def get_gradients(
        ...
        with backends.cudnn.flags(enabled=False):
            outputs = self._model.make_output_human_readable(self._model.forward(**dataset_tensor_dict))  # type: ignore
