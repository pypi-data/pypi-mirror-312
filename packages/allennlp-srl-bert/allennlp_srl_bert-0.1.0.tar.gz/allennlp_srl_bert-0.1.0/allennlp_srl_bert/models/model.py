...
from allennlp_srl_bert.common.checks import ConfigurationError
from allennlp_srl_bert.common.params import Params, remove_keys_from_params
from allennlp_srl_bert.common.registrable import Registrable
from allennlp_srl_bert.data import Instance, Vocabulary
from allennlp_srl_bert.data.batch import Batch
from allennlp_srl_bert.nn import util
from allennlp_srl_bert.nn.module import Module
from allennlp_srl_bert.nn.parallel import DdpAccelerator
from allennlp_srl_bert.nn.regularizers import RegularizerApplicator
...
class Model(Module, Registrable):
    ...
    ddp_accelerator : `Optional[DdpAccelerator]`, optional
        The :class:`srl_bert.nn.parallel.ddp_accelerator.DdpAccelerator` used in distributing training.
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        `srl_bert.training.Trainer` in order to compute and use model metrics for early
    ...
    def from_archive(cls, archive_file: str, vocab: Vocabulary = None) -> "Model":
        ...
        """
        from allennlp_srl_bert.models.archival import (
            load_archive,
