...
from allennlp_srl_bert.common.file_utils import cached_path
from allennlp_srl_bert.data.dataset_readers.dataset_reader import DatasetReader
from allennlp_srl_bert.data.fields import (
    Field,
    TextField,
    SequenceLabelField,
    MetadataField,
...
from allennlp_srl_bert.data.token_indexers import SingleIdTokenIndexer, TokenIndexer
from allennlp_srl_bert.data.tokenizers import Token
from allennlp_srl_bert.common.ontonotes import Ontonotes, OntonotesSentence
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if token_indexers is not None:
            ...
            from allennlp_srl_bert.data.token_indexers import (
