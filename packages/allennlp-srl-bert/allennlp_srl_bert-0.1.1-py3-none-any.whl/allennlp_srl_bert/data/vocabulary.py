...
from allennlp_srl_bert.common import Registrable
from allennlp_srl_bert.common.file_utils import cached_path, FileLock
from allennlp_srl_bert.common.checks import ConfigurationError
from allennlp_srl_bert.common.tqdm import Tqdm
from allennlp_srl_bert.common.util import namespace_match

if TYPE_CHECKING:
    from allennlp_srl_bert.data import instance as adi  # noqa
...
def _read_pretrained_tokens(embeddings_file_uri: str) -> List[str]:
    ...
    from allennlp_srl_bert.modules.token_embedders.embedding import EmbeddingsTextFile
...
class Vocabulary(Registrable):
    ...
    def from_pretrained_transformer(
        ...
        """
        from allennlp_srl_bert.common import cached_transformers
...
Vocabulary.register(
    "from_pretrained_transformer", constructor="from_pretrained_transformer"
)(Vocabulary)
Vocabulary.register(
