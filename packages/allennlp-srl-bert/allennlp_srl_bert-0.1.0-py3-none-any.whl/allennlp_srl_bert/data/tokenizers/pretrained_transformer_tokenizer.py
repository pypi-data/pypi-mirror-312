...
from allennlp_srl_bert.common.util import sanitize_wordpiece
from allennlp_srl_bert.data.tokenizers.token_class import Token
from allennlp_srl_bert.data.tokenizers.tokenizer import Tokenizer
...
class PretrainedTransformerTokenizer(Tokenizer):
    ...
    def __init__(
        ...
        if verification_tokens is None:
            ...
            self._reverse_engineer_special_tokens(
                token_a, token_b, model_name, tokenizer_kwargs
            )
    ...
    def intra_word_tokenize_sentence_pair(
        ...
        List[Token], List[Optional[Tuple[int, int]]], List[Optional[Tuple[int, int]]]
    ]:
        """
        Tokenizes each word into wordpieces separately and returns the wordpiece IDs.
