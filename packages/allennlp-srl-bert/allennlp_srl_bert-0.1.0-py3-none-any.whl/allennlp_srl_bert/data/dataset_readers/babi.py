...
from allennlp_srl_bert.data.dataset_readers.dataset_reader import (
    DatasetReader,
    PathOrStr,
)
from allennlp_srl_bert.data.instance import Instance
from allennlp_srl_bert.data.fields import Field, TextField, ListField, IndexField
from allennlp_srl_bert.data.token_indexers import TokenIndexer, SingleIdTokenIndexer
