...
BENCHMARK_CURVE_NAME = {
    ...
    'LIBI': 'Rate at which major international banks are willing to take deposits from one another, is normally 1/8 percent below LIBOR._x000D_ _x000D_ London InterBank Bid Rate, the rate bid by banks on Eurocurrency deposits; the international rate that banks lend to other banks',
    ...
    'TONA': 'Tokyo Overnight Average Rate:_x000D_ Interest rate benchmark - also known as a reference rate or a benchmark rate. It is a measure of the cost of borrowing in the Japanese yen unsecured overnight money market and is the near risk-free rate (RFR) for Japanese yen markets, administered and published by the Bank of Japan. It is sometimes referred to as “TONAR”',
    'TORF': 'Tokyo Term Risk Free Rate:_x000D_ Interest rate Benchmark based on the uncollateralized overnight call rate which involves almost no credit risk of financial institutions, based on the Japanese Yen "Risk-Free-Rate" (RFR), administered and published by QUICK Benchmarks, Inc',
    'SIBO': 'Singapore Interbank Offered Rate._x000D_',
...
CLEARING_SYSTEM_IDENTIFICATION = {
    ...
    'KRBOK': 'Participant Institution code used by BOK-Wire+ in South Korea',
}
...
PROXY_ACCOUNT_TYPE = {
    ...
    'CINC': 'Corporate Identification issued by a national institution or regulator, used as account proxy. (applied for corporate account proxy)',
    ...
    'NIDN': 'Unique government-issued Identification used as account proxy to identify the individual or corporate for example for public benefits, government subsidies) and typically linked to the individual\'s / corporate bank account. (applied for corporate or individual account proxy)',
    'CCPT': 'Unique government-issued Identification used as account proxy to identify the individual (for example for government charges, road taxes, vaccination charges) and typically linked to the individual\'s bank account (applied for individual account proxy)',
...
SERVICE_LEVEL = {
    ...
    'G005': 'Tracked Instant Customer Credit Transfer._x000D_ _x000D_',
