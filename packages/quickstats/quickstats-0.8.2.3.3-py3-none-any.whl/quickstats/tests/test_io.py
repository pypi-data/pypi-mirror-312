...
from quickstats.core.io import (
    TextColors,
    Verbosity,
    VerbosePrint,
    switch_verbosity,
...
class TestVerbosePrint(unittest.TestCase):
    """Test VerbosePrint class functionality."""

    def setUp(self):
        self.printer = VerbosePrint(
...
class TestVerbositySwitch(unittest.TestCase):
    ...
    def test_switch_verbosity(self):
        ...
        printer = VerbosePrint(verbosity=Verbosity.INFO)
...
class TestDefaultFormat(unittest.TestCase):
    ...
    def test_set_default_format(self):
        ...
        printer = VerbosePrint()  # Should use new default
        self.assertEqual(
            printer._formatter._fmt,
            VerbosePrint.FORMATS["detailed"]
        )
