...
class SediflowExport(HydroflowExport):
    ...
    def __export_data(self,write=True):
        ...
        # if self.model.is_sediments_conservation : input_data['model']['mass conservation check'] = self.model.is_sediments_conservation           #currently unused (à venir avec bank_failure)
