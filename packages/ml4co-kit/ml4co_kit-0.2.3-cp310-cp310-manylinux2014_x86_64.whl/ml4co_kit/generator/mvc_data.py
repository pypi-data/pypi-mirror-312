...
class MVCDataGenerator:
    def __init__(
        ...
        save_path: pathlib.Path = "data/mvc/er",
        filename: str = None,
        # args for generate
        ...
        Args:
            ...
            save_path (pathlib.Path, optional):
                The save path of mvc samples/datasets.
            filename (str, optional):
                The filename of mvc samples.
            graph_weighted (bool, optional):
                If enabled, generate the weighted MVC problem instead of MVC.
    ...
    def get_filename(self):
        if self.filename is None:
            self.filename = (
                f"mvc_{self.data_type}_{self.nodes_num_min}_{self.nodes_num_max}"
            )
    ...
    def generate(self):
        ...
        for _ in tqdm(
            ...
            desc=f"Solving MVC Using {self.solver_type}",
        ):
        ...
        print(
            f"Completed generation of {self.samples_num} samples of MVC."
        )
