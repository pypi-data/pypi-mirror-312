...
#         self.section = self.extra_kwargs.get("section", {})
#         self.fields = {
...
class SectionField(BasicFieldSerializer, serializers.JSONField):
    """
    _summary_
...
class SectionManyField(BasicFieldSerializer, serializers.JSONField):
    """
    _summary_
