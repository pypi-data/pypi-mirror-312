...
class BasicFieldSerializer:
    ...
    def __init__(self, *args, extra_kwargs=None, required=None, **kwargs):
        ...
        default = kwargs.pop("default", self.default) if required else self.default
        super(BasicFieldSerializer, self).__init__(*args, required=required, **kwargs)
    ...
    def is_disabled_by_rules(self, enabled_rules):
        ...
        Returns:
            _type_: _description_
        """
        is_disabled = self.extra_kwargs.get("disabled") or self.data is None or False
