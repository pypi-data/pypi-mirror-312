...
def run_file(path: "char const *", globals: "PyObject *"=None, locals: "PyObject *"=None) -> "PyObject *":
...
def chk_semver(version: "char const *", n: "int"=-1) -> "int":
    r"""
...
def cmp_semver(v1: "char const *", v2: "char const *", n: "int"=-1) -> "int":
    r"""
...
def uriencode(INPUT: "char const *") -> "char *":
    r"""
...
def uridecode(INPUT: "char const *") -> "size_t *":
    r"""
...
def _from_bytes(driver: "char const *", INPUT_BYTES: "unsigned char *", id: "char const *"=None, options: "char const *"=None, metaid: "char const *"=None) -> "struct _DLiteInstance *":
    r"""
...
def _behavior_recordno(n: "size_t") -> "struct _DLiteBehavior const *":
    r"""
...
def _behavior_record(name: "char const *") -> "struct _DLiteBehavior const *":
    r"""
...
def _behavior_get(name: "char const *") -> "int":
    r"""
...
def _behavior_set(name: "char const *", value: "int") -> "int":
    r"""
...
class _DLiteJStoreIter(object):
    ...
    def __init__(self, js: "_JStore", pattern: "char const *"=None):
        r"""
...
class _JStore(object):
    ...
    def remove(self, id: "char const *") -> "void":
        r"""
        remove(self, id)
    ...
    def _get(self, id: "char const *"=None) -> "struct _DLiteInstance *":
        r"""_get(self, id=None) -> Instance"""
        return _dlite._JStore__get(self, id)

    def get_json(self, id: "char const *") -> "char const *":
        r"""
    ...
    def get_single_id(self) -> "char const *":
        r"""
    ...
    def get_ids(self, pattern: "char const *"=None) -> "struct _DLiteJStoreIter *":
        r"""
    ...
    def __iadd__(self, other: "_JStore") -> "struct _JStore *":
