        ...
        if version_info:
            ...
            if version_info.get("gaia_changeset"):
                self.env["Gaia revision"] = html.a(
                    ...
                    href="https://git.kaiostech.com/KaiOS/gaia/commit/%s" % version_info.get("gaia_changeset"),
                    target="_blank")
        ...
        with open(os.path.join(base_path, "main.js")) as main_f:
            doc = html.html(
                ...
                html.body(
                    ...
                    html.p('Report generated on %s at %s by KaiOS' % (
                    ...
                    html.p('%i tests ran in %.1f seconds.' % (sum(self.test_count.itervalues()),
                           ...
                           html.span('%i failed(failure or exception)' % (
                               self.test_count["UNEXPECTED_FAIL"] + self.test_count["UNEXPECTED_ERROR"]),
                                     class_='failure_and_exception'), '. ',
                           html.br(),
