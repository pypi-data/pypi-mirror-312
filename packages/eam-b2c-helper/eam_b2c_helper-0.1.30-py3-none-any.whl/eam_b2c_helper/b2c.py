...
def build_local_user_object(user_details: dict, b2c_prefix: str, extension_id: str) -> dict:
    ...
    if user_details['external_user_state']:
        user_details['externalUserState'] = 'Accepted'
        user_details['externalUserStateChangeDateTime'] = datetime.datetime.now(
        ).strftime("%Y-%m-%dT%H:%M:%SZ")

    else:
        user_details['externalUserState'] = None
        user_details['externalUserStateChangeDateTime'] = None
    ...
    return {
        ...
        'externalUserState': user_details['externalUserState'],
        'externalUserStateChangeDateTime': user_details['externalUserStateChangeDateTime'],
        "identities": [
            {
