...
class SerraWatchLogger:
    ...
    def __new__(self, name: str = __name__):
        ...
        if SerraWatchLogger._instance is not None:
            return

        SerraWatchLogger._instance = self
    ...
    def get_instance(name: str = __name__):
        if SerraWatchLogger._instance is None:
            SerraWatchLogger(name)
        return SerraWatchLogger._instance
