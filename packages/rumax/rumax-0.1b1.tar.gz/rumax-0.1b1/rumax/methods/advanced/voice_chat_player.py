...
class VoiceChatPlayer:
    async def heartbeat(self: "rumax.Client", chat_guid: str, voice_chat_id: str) -> None:
        """
        ...
        while True:
            ...
            except (rumax.exceptions.InvalidAuth, rumax.exceptions.InvalidInput):
                break

            except Exception:
                continue

    async def speaking(self: "rumax.Client", chat_guid: str, voice_chat_id: str) -> None:
        """
    ...
    async def voice_chat_player(self: "rumax.Client", chat_guid: str, media: "pathlib.Path", loop: bool = False) -> bool:
        """
