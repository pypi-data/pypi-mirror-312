...
class ReportObject:
    async def report_object(
            self: "rumax.Client",
            object_guid: str,
            report_type: "rumax.enums.ReportType",
            description: str = None,
            message_id: str = None,
            report_type_object: "rumax.enums.ReportTypeObject" = 'Object',
    ) -> rumax.types.Update:
        """
        ...
        Args:
            ...
            report_type (rumax.enums.ReportType): The type of report.
        ...
        Returns:
            rumax.types.Update: The update containing information about the report.
        """
        input = dict(
