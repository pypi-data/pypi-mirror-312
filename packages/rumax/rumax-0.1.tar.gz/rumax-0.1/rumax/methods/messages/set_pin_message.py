...
class SetPinMessage:
    async def set_pin_message(
        ...
        Returns:
            - rumax.types.Update: The update indicating the success of the operation.
        """
    ...
    async def set_pin(
        ...
        Returns:
            - rumax.types.Update: The update indicating the success of setting the pin.
        """
    ...
    async def set_unpin(
        ...
        Returns:
            - rumax.types.Update: The update indicating the success of unsetting the pin.
        """
        return await self.set_pin_message(object_guid=object_guid,
