...
class TestBirthday:
    ...
    hash_vectors: list[tuple[int, float, int]] = [
        ...
        (384, 1e-17, 8900000000000000471357641515784838152032029245440),
        (384, 1e-14, 279999999999999979824980686778662580981931284889600),
        (384, 1e-11, 8900000000000000471357641515784838152032029245440000),
        (384, 1e-08, 279999999999999998101865628821255833409278363744337920),
        (384, 1e-05, 8899999999999999641919372145997333460056423630504984576),
        (384, 0.01, 280000000000000008310336636449409737310516586697384263680),
        (384, 0.1, 889999999999999975080972956069764176833629800867081224192),
        (
            384,
            0.25,
            4800000000000000092684464663841168841538056056222209015808,
        ),
        (384, 0.5, 7400000000000000113851121046168386415163203252498351521792),
        (
            384,
            0.75,
