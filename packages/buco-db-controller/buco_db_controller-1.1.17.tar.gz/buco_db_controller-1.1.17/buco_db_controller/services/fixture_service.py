...
class FixtureService:
    ...
    def get_previous_fixture(self, fixture) -> Optional[Fixture]:
        ht_fixtures = self.get_team_fixtures(fixture.ht.team_id, fixture.league.league_id, fixture.season)
        at_fixtures = self.get_team_fixtures(fixture.at.team_id, fixture.league.league_id, fixture.season)
        ...
        previous_ht_fixture = None
        previous_at_fixture = None
        if not ht_fixtures:
            previous_ht_fixture = ht_fixtures[-1]
        if not at_fixtures:
            previous_at_fixture = at_fixtures[-1]

        return {'ht': previous_ht_fixture, 'at': previous_at_fixture}
