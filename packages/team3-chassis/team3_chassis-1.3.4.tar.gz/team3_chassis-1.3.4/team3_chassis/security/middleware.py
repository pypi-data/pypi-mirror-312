...
class AutenticationMiddleware(BaseHTTPMiddleware):    
    def __init__(self, app, valid_routes=None, ask_for_keys:bool= None, generate_keys:bool= None, client_microservice_ip:str= None, client_microservice_port:int= None, role:str=None,security_service:SecurityProvider=None):
        super().__init__(app)
