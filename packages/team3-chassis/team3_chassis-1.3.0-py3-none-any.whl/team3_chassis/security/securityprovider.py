...
from team3_chassis.discovery.consulprovider import ConsulProvider
...
class SecurityProvider:
    ...
    @classmethod
    async def create(cls, generate_keys: bool, ask_for_keys: bool,consul_provider: ConsulProvider):
    ...
    def get_public_key(self):
        ...
        if service["Address"] is None or service["Port"] is None:
            raise ValueError("Client service not found in Consul")
