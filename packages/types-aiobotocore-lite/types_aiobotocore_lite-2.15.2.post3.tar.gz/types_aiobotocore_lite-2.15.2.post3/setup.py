...
setup(
    ...
    description="Type annotations for aiobotocore 2.15.2 generated with mypy-boto3-builder 8.4.2",
    classifiers=[
    ...
    keywords="aiobotocore aiobotocore-stubs mypy typeshed autocomplete",
