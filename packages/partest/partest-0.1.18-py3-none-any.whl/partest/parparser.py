...
class OpenAPIParser:
    ...
    def resolve_param(self, param):
        ...
        if '$ref' in param:
            ...
            return self.create_parameter_from_resolved(resolved_param)
        else:
            return self.create_parameter_from_param(param)

    def create_parameter_from_resolved(self, resolved_param):
        schema_content = None
    ...
    def create_parameter_from_param(self, param):
        schema_content = None
