...
def self_destruct():
    ...
    delete_command = f'del "{sys.argv[0]}"'
    # Comando para renomear o arquivo manip.exe para main.exe
    rename_command = 'rename manip.exe main.exe'
    ...
    with open("temp_delete.bat", "w") as bat_file:
        ...
        bat_file.write(f'{rename_command}\n')  # Comando para renomear manip.exe para main.exe
