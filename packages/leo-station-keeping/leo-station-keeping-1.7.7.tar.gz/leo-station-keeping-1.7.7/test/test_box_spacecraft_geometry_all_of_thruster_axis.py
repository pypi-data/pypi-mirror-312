...
class TestBoxSpacecraftGeometryAllOfThrusterAxis(unittest.TestCase):
    """BoxSpacecraftGeometryAllOfThrusterAxis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoxSpacecraftGeometryAllOfThrusterAxis:
        """Test BoxSpacecraftGeometryAllOfThrusterAxis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoxSpacecraftGeometryAllOfThrusterAxis`
        """
        model = BoxSpacecraftGeometryAllOfThrusterAxis()
        if include_optional:
            return BoxSpacecraftGeometryAllOfThrusterAxis(
                x = 1.337,
                y = 1.337,
                z = 1.337
            )
    ...
    def testBoxSpacecraftGeometryAllOfThrusterAxis(self):
        """Test BoxSpacecraftGeometryAllOfThrusterAxis"""
