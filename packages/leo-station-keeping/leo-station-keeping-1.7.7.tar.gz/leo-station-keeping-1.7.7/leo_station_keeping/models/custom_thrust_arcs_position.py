...
class CustomThrustArcsPosition(BaseModel):
    """
    If <b>thrustArcsPosition</b> is set to <b>CUSTOM</b>, the custom thrust arcs position option will be required and make it possible to place the burn arcs anywhere on the orbit. 
    """ # noqa: E501
    reference: StrictStr = Field(description="The reference for custom arcs")
    delta_mean_longitude_argument: Union[StrictFloat, StrictInt] = Field(description="The delta mean longitude argument (in rad)", alias="deltaMeanLongitudeArgument")
