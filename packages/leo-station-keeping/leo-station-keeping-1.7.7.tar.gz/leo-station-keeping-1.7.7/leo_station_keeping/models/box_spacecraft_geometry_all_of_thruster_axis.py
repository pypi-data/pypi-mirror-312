...
class BoxSpacecraftGeometryAllOfThrusterAxis(BaseModel):
    """
    BoxSpacecraftGeometryAllOfThrusterAxis
    """ # noqa: E501
    x: Union[StrictFloat, StrictInt] = Field(description="The axis in the X direction")
    y: Union[StrictFloat, StrictInt] = Field(description="The axis in the Y direction")
    z: Union[StrictFloat, StrictInt] = Field(description="The axis in the Z direction")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoxSpacecraftGeometryAllOfThrusterAxis from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BoxSpacecraftGeometryAllOfThrusterAxis from a dict"""
        if obj is None:
            return None
