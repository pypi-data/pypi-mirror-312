...
class DeployableFixedSolarArray(SolarArray):
    ...
    """ # noqa: E501
    normal_direction: Axis = Field(alias="normalDirection")
    surface: Union[StrictFloat, StrictInt] = Field(description="The surface of the solar array (in square meters) The solar array surface is considered alongside the box dimensions to calculate the spacecraft's surface area. ")
