...
class Platform(BaseModel):
    ...
    Platform
    """ # noqa: E501
    mass: Union[StrictFloat, StrictInt] = Field(description="The platform mass (in kilograms).  The thruster mass as well as its propellant mass is not counted in this platform mass. ")
    on_board_average_power: Union[StrictFloat, StrictInt] = Field(description="The average power available for firing (in watts). If power system is simulated (with a Battery and a SolarArray), this value is used to determine the length of the thrust arc(s) if DUTY_CYCLE mode as been  chosen. In this case the duty cycle will be dutyCycle = onBoardAveragePower / PropulsionSystem.power. ", alias="onBoardAveragePower")
