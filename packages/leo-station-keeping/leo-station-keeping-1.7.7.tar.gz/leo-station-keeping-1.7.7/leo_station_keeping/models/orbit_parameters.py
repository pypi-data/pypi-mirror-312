...
class OrbitParameters(BaseModel):
    """
    The orbit parameters related to the orbit radius, altitude, semi-major axis and/or eccentricity
    """ # noqa: E501
    parameters_type: StrictStr = Field(description="The orbit parameters type", alias="parametersType")
