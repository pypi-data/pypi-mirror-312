...
class EllipticalPerigeeAltApogeeAltOrbitParameters(OrbitParameters):
    ...
    """ # noqa: E501
    perigee_altitude: Union[StrictFloat, StrictInt] = Field(description="The orbit perigee altitude (in meters)", alias="perigeeAltitude")
    apogee_altitude: Union[StrictFloat, StrictInt] = Field(description="The orbit apogee altitude (in meters)", alias="apogeeAltitude")
