...
class SpacecraftGeometryDimension(BaseModel):
    ...
    """ # noqa: E501
    x: Union[StrictFloat, StrictInt] = Field(description="The spacecraft geometry dimension in the X direction")
    y: Union[StrictFloat, StrictInt] = Field(description="The spacecraft geometry dimension in the Y direction")
    z: Union[StrictFloat, StrictInt] = Field(description="The spacecraft geometry dimension in the Z direction")
