...
class SphericalSpacecraftGeometry(SpacecraftGeometry):
    ...
    """ # noqa: E501
    spherical_cross_section: Union[StrictFloat, StrictInt] = Field(description="Represents an average cross section of the spacecraft, regardless of its orientation.", alias="sphericalCrossSection")
