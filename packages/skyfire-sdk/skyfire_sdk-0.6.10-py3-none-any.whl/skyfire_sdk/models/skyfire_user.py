...
class SkyfireUser(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "username", "email", "isAdmin", "isEnterpriseAdmin", "isActive", "isOnboarded", "userType", "createdDate", "updatedDate", "attributes", "parentUserId", "stytchUserId", "stripeCustomerId", "rules", "#parentUser", "#userOrganizations", "#wallets", "#defaultWallet", "#organizationWallets"]
