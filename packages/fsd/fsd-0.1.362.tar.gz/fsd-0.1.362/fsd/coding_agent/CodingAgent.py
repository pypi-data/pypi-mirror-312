    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- Strictly follow existing UI patterns and design system\n"
                "- Create elegant, intuitive interfaces with perfect visual hierarchy\n"
                "- Implement responsive layouts with mobile-first approach\n" 
                "- Use semantic HTML and follow accessibility standards (WCAG)\n"
                "- Optimize performance with efficient CSS/JS techniques\n"
                "- Add smooth transitions and meaningful micro-interactions\n"
