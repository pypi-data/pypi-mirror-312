...
class FileContentManager:
    ...
    def find_similar_lines(cls, search: str, content: str, num_lines: int = 5) -> dict:
        ...
        if best_ratio < cls.SIMILARITY_THRESHOLD / 100:
        ...
        best_match_end = min(len(content_lines), best_match_i + len(search_lines) + num_lines)
        best_match_start = max(0, best_match_i - num_lines)
