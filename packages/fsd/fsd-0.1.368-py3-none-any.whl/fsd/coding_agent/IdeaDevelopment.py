...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "UI-Related Files:\n"
            "MANDATORY UI/UX File Organization:\n"
            "1. Global Styles:\n"
            "   - Create global.css/styles.css for project-wide styles\n"
            "   - Include CSS reset/normalize\n"
            "   - Define design tokens (colors, typography, spacing)\n"
            "   - Set up responsive breakpoints\n"
            "   - Define utility classes\n\n"
            "2. Component-Level Styles:\n"
            "   - For HTML: Create matching .css file for each .html\n"
            "   - For React: Create [Component].module.css for each component\n"
            "   - For Vue: Use <style scoped> or .vue files\n"
            "   - For Angular: Create [component].component.scss files\n\n"
            "3. Layout Organization:\n"
            "   - Create layouts/ directory for page templates\n"
            "   - Separate header/footer/sidebar components\n"
            "   - Define grid systems and containers\n\n"
            "4. Theme Configuration:\n"
            "   - Set up theme variables (dark/light modes)\n"
            "   - Define brand-specific styles\n"
            "   - Create mixins/functions for reusable styles\n\n"
            "5. Asset Management:\n"
            ...
            "   - Standard breakpoints in global styles\n"
            "   - Component-specific media queries\n\n"
            "7. Accessibility:\n"
            "   - ARIA attributes in components\n"
            "   - Focus states in global styles\n"
            ...
            "│   ├── Button/\n"
            "│   │   ├── Button.[jsx|tsx|vue]\n"
            "│   │   └── Button.styles.[css|scss|module.css]\n"
            "│   └── Card/\n"
            "│       ├── Card.[jsx|tsx|vue]\n"
            "│       └── Card.styles.[css|scss|module.css]\n"
            "└── layouts/\n"
            "    ├── MainLayout/\n"
            "    │   ├── MainLayout.[jsx|tsx|vue]\n"
            "    │   └── MainLayout.styles.[css|scss|module.css]\n"
            "    └── components/\n"
            "        ├── Header/\n"
            "        └── Footer/\n\n"
