    ...
    async def get_fixing_request(self, instruction, file_content, all_file_content, tech_stack):
        ...
        try:
            ...
            if lines and "> REPLACE" in lines[-1]:
                ...
                logger.info(" #### Extending response - getting additional content (1/5)")
                ...
                if continuation_lines and "> REPLACE" in continuation_lines[-1]:
                    ...
                    logger.info(" #### Extending response - getting additional content (2/5)")
                    ...
                    if continuation_lines and "> REPLACE" in continuation_lines[-1]:
                        ...
                        logger.info(" #### Extending response - getting additional content (3/5)")
                        ...
                        if continuation_lines and "> REPLACE" in continuation_lines[-1]:
                            ...
                            logger.info(" #### Extending response - getting additional content (4/5)")
                            ...
                            if continuation_lines and "> REPLACE" in continuation_lines[-1]:
                                ...
                                logger.info(" #### Extending response - getting additional content (5/5)")
