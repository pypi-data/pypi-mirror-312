...
class FileManagerAgent:
    ...
    async def get_file_planning(self, idea):
        ...
        prompt = (
                ...
                "Existing_files must include only the full paths for file names explicitly mentioned in the instruction that will be updated or modified. Exclude all image/asset files except .svg files. "
                ...
                "    ]\n"
                "}\n\n"
                "Existing_files, and Adding_new_files must include only files explicitly mentioned in the instruction.\n"
