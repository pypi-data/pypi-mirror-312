...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "UI-Related Files (MANDATORY FOR ALL PROJECTS):\n"
            "- Styling Architecture:\n"
            "  • Global Styles: MUST create global.css/styles.css for project-wide styles\n" 
            "  • Component Styles: MUST create separate style file for EACH component\n"
            "  • Theme Variables: MUST define colors, typography, spacing in dedicated variables file\n"
            "  • Utility Classes: MUST create utilities.css for common patterns\n"
            "  • Responsive Breakpoints: MUST define in breakpoints.scss/css\n"
            "  • Layout System: MUST create grid/layout system files\n\n"
            "- Framework-Specific Requirements:\n"
            "  • React/Vue: \n"
            "    - MUST create ComponentName.styles.{css/scss/module.css} for each component\n"
            "    - MUST use CSS-in-JS or CSS Modules for scoped styles\n"
            "    - MUST create theme provider wrapper\n"
            "  • Angular:\n"
            "    - MUST create component.styles.scss for each component\n"
            "    - MUST use ViewEncapsulation for style isolation\n"
            "    - MUST create theme service\n"
            "  • HTML/CSS:\n"
            "    - MUST create page.css for each HTML file\n"
            "    - MUST use BEM methodology\n"
            "    - MUST create modular SCSS partials\n\n"
            "- Mandatory Style Organization:\n"
            "  • src/styles/\n"
            "    ├── global/\n"
            "    │   ├── variables.{css/scss}\n"
            "    │   ├── typography.{css/scss}\n"
            ...
            "  • MUST use relative units (rem/em) over pixels\n"
            "  • MUST implement dark mode support\n"
            "  • MUST add print stylesheets\n"
            "  • MUST optimize for performance (Critical CSS)\n"
