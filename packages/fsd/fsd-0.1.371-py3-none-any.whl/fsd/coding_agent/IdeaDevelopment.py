...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "1.3 UI/UX Implementation (MANDATORY for ALL projects):\n"
            "For EVERY UI component or page, MUST create:\n"
            "1. Component Structure:\n"
            "   - Main component file (e.g., Button.tsx, ProductCard.jsx)\n"
            "   - Dedicated style file (e.g., Button.module.css, ProductCard.styles.ts)\n"
            "   - Types/interfaces file if using TypeScript (e.g., Button.types.ts)\n"
            "   - Unit test file (e.g., Button.test.tsx)\n\n"
            ...
            "4. Style Requirements (MANDATORY):\n"
            "   - Use CSS Modules or styled-components for component styles\n"
            "   - Implement responsive breakpoints in EVERY component\n"
            "   - Define consistent spacing using CSS variables\n"
            "   - Use semantic class names (BEM if using CSS)\n"
            "   - Implement dark/light theme support\n"
            "   - Add hover, focus, active states for interactive elements\n"
            "   - Include loading, error, and empty states\n"
            "   - Ensure WCAG 2.1 AA compliance\n\n"
            "5. Layout Structure (MANDATORY):\n"
            "   - Use CSS Grid for page layouts\n"
            "   - Use Flexbox for component layouts\n"
            "   - Implement proper spacing hierarchy\n"
            "   - Ensure consistent padding/margins\n"
            "   - Add proper breakpoints for all viewport sizes\n\n"
            "6. Page-Specific Styles (MANDATORY):\n"
            "   - MUST create dedicated CSS file for EVERY page/view\n"
            "   Example for traditional web:\n"
            "   pages/\n"
            "   ├── home/\n"
            "   │   ├── home.html\n"
            ...
            "   └── search/\n"
            "       ├── search.html\n"
            "       └── search.css     # Styles specific to search page\n\n"
