...
class ShortIdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "1. Global Styles:\n"
            "   - Create src/styles/global.css for project-wide styles\n"
            "   - Create src/styles/variables.css for design tokens\n"
            "   - Create src/styles/reset.css for CSS reset\n"
            "   - Create src/styles/utilities.css for utility classes\n"
            "   - Define responsive breakpoints\n"
            "   - Set up theme variables (dark/light modes)\n\n"
            "2. Component-Level Styles:\n"
            "   For HTML projects:\n"
            "   - Create matching .css file for each .html\n"
            "   - Example: header.html -> header.css\n\n"
            "   For React projects:\n"
            "   - Create [Component].module.css for each component\n"
            "   - Example: Button.tsx -> Button.module.css\n\n"
            "   For Vue projects:\n"
            "   - Use <style scoped> in .vue files\n"
            "   - Or create [Component].vue.css for separate files\n\n"
            "   For Angular projects:\n"
            "   - Create [component].component.scss files\n"
            "   - Follow Angular style naming conventions\n\n"
            "3. Layout Organization:\n"
            "   - Create src/layouts/ directory\n"
            "   - Separate components for header/footer/sidebar\n"
