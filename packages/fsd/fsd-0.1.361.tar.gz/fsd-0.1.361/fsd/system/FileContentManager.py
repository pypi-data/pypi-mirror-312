...
class FileContentManager:
    ...
    async def apply_changes(cls, file_path: str, blocks: List[Tuple[str, str]]) -> str:
        ...
        if failed_blocks > 0:
            log_path = os.path.join(cls.repo.get_repo_path(), 'failed_blocks.log')
            try:
    ...
    @classmethod
    def find_similar_lines(cls, search: str, content: str, threshold: float = 0.6) -> dict:
        """
        ...
        Returns:
            dict: Contains similar lines and their indices
        """
