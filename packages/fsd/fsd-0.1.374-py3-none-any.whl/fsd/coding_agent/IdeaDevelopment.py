...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "UI-Related Files - CRITICAL STYLING REQUIREMENTS:\n"
            "Every UI file MUST have its own dedicated styling file, regardless of tech stack. This is NON-NEGOTIABLE.\n\n"
            ...
            "│       ├── header.css            # Styles for header.html\n"
            "│       └── footer.css            # Styles for footer.html\n"
            "├── pages/\n"
            "│   ├── home/\n"
            "│   │   ├── home.html            # Home page markup\n"
            ...
            "│   │   └── TheHeader.css      # Header specific styles\n"
            "│   └── TheFooter/\n"
            "│       ├── TheFooter.vue      # Footer component\n"
            "│       └── TheFooter.css      # Footer specific styles\n"
            "└── views/\n"
            "    ├── HomeView/\n"
            "    │   ├── HomeView.vue       # Home view component\n"
            "    │   └── HomeView.css       # Home view specific styles\n"
            "    └── AboutView/\n"
            "        ├── AboutView.vue      # About view component\n"
            "        └── AboutView.css      # About view specific styles\n"
            "```\n\n"
            ...
            "1. EVERY UI file MUST have its own CSS file - NO EXCEPTIONS\n"
            "2. Global styles MUST be separate from component/page styles\n"
            "3. CSS files MUST be co-located with their UI files\n"
            "4. CSS file names MUST match their UI file names\n"
            "5. NO inline styles allowed except for dynamic values\n"
            "6. NO sharing CSS files between components/pages\n"
            "7. Component libraries (e.g., Material-UI, Chakra) still require custom CSS files\n\n"
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"│       └── new_file.css          # Required dedicated style file\n"
            f"└── new_location/                 # File being moved here\n"
            f"    ├── moved_file.py             # Moved from old location\n"
            f"    └── moved_file.css            # Required dedicated style file\n"
            f"```\n"
            f"CRITICAL UI/UX RULES:\n"
            f"1. EVERY UI file MUST have its own dedicated styling file - NO EXCEPTIONS\n"
            f"2. Style files MUST be co-located with their UI files\n"
            f"3. Style file names MUST match their UI file names\n"
            f"4. Global styles MUST be separate from component/page styles\n"
            f"5. NO sharing style files between components/pages\n"
            f"6. NO inline styles except for dynamic values\n"
            f"7. Component libraries still require dedicated style files\n\n"
            ...
            f"- UI files without dedicated style files\n"
