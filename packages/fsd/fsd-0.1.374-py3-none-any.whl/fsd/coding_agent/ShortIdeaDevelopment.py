...
class ShortIdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context, file_attachments, assets_link):
        ...
        system_prompt = (
            ...
            "CRITICAL: Every UI file MUST have its own dedicated style file, regardless of tech stack:\n\n"
            "1. HTML/CSS Projects:\n"
            "Example structure:\n"
            "src/\n"
            "├── pages/\n"
            "│   ├── home/\n"
            "│   │   ├── home.html\n"
            "│   │   └── home.css       # Dedicated CSS for home page\n"
            "│   ├── products/\n"
            "│   │   ├── products.html\n"
            "│   │   └── products.css   # Dedicated CSS for products page\n"
            "│   └── contact/\n"
            "│       ├── contact.html\n"
            "│       └── contact.css    # Dedicated CSS for contact page\n"
            "└── styles/\n"
            ...
            "│   └── Footer/\n"
            "│       ├── Footer.tsx\n"
            "│       └── Footer.module.css  # Component-specific styles\n"
            "├── pages/\n"
            "│   ├── Dashboard/\n"
            "│   │   ├── Dashboard.tsx\n"
            ...
            "├── components/\n"
            "│   ├── NavBar/\n"
            "│   │   ├── NavBar.vue          # Contains <template>, <script>, and\n"
            "│   │   └── NavBar.scss         # Dedicated styles\n"
            "│   └── UserCard/\n"
            "│       ├── UserCard.vue\n"
            "│       └── UserCard.scss\n"
            "└── views/\n"
