...
class VignaleGamma:
    ...
    def __init__(self, E, Te, N, V) -> None:
        ...
        self.fg_Ef = fg_params.Ef
        self.fg_mu = fg_params.mu
        self.fg_V_au = fg_params.V_au
        self.fg_kf = fg_params.kf
        self.fg_rs = fg_params.rs
        self.fg_N0 = fg_params.N0
        ...
        self.qh_gamma = get_qh_gamma(self.E, self.mu, self.T, self.Ef, self.xi3)
        self.qp_gamma = get_qp_gamma(self.E, self.mu, self.T, self.Ef, self.xi3)
