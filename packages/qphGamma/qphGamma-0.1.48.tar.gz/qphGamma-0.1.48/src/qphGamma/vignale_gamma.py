...
class VignaleGamma:
    ...
    def __init__(self, E, Te, N, V) -> None:
        ...
        self.dos = fg_dos.dos
        self.integrated_mu = integrate_for_mu(self.Te, self.N, self.E, self.dos)
        # occ = logistic.sf(self.E, self.mu, self.Te)
        # dos = get_fg_dos(self.E, self.Te, self.N, self.N)
