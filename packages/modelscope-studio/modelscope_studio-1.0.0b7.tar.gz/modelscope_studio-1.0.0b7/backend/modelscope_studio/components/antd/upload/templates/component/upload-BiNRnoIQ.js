import { g as pe, w as U } from "./Index-B4udXh5e.js";
const b = window.ms_globals.React, J = window.ms_globals.React.useMemo, ae = window.ms_globals.React.forwardRef, de = window.ms_globals.React.useRef, ue = window.ms_globals.React.useState, fe = window.ms_globals.React.useEffect, j = window.ms_globals.ReactDOM.createPortal, we = window.ms_globals.antd.Upload;
var Y = {
  exports: {}
}, k = {};
/**
...
function Ne(e) {
  ...
  return {
    ...
    p(i, [a]) {
      ...
      16 && F(t, 1)) : (t = H(i), t.c(), F(t, 1), t.m(s.parentNode, s)) : t && (Le(), D(t, 1, 1, () => {
        t = null;
      }), ge());
    },
    i(i) {
...
function Ae(e, n, o) {
  ...
  const w = U();
  q(e, w, (d) => o(1, r = d));
  const c = [], m = je("$$ms-gr-react-wrapper"), {
    slotKey: f,
    slotIndex: v,
    subSlotIndex: g
  } = pe() || {}, E = l({
...
function T(e) {
  ...
  if (e._reactElement)
    return n.push(j(b.cloneElement(e._reactElement, {
