...
function D(e, t) {
  return t.clone !== !1 && t.isMergeableObject(e) ? I(Et(e), e, t) : e;
}
function xt(e, t, r) {
...
function yt(e, t, r) {
  ...
  return r.isMergeableObject(e) && de(e).forEach(function(i) {
    ...
    _t(e, i) || (Me(e, i) && r.isMergeableObject(t[i]) ? n[i] = vt(i, r)(e[i], t[i], r) : n[i] = D(t[i], r));
  }), n;
}
function I(e, t, r) {
  r = r || {}, r.arrayMerge = r.arrayMerge || xt, r.isMergeableObject = r.isMergeableObject || ft, r.cloneUnlessOtherwiseSpecified = D;
...
var Xe = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/, It = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;
function Nt(e) {
  var t = {};
  return e.replace(It, function(r) {
    var n = r.length;
    switch (r[0]) {
      case "G":
...
function wt(e) {
  ...
  for (var t = e.split(Ot).filter(function(l) {
    return l.length > 0;
...
var ye = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, ke = /^(@+)?(\+|#+)?[rs]?$/g, Ct = /(\*)(0+)|(#+)(0+)|(0+)/g, ze = /^(0+)$/;
function He(e) {
  var t = {};
...
function Rt(e) {
  for (var t = {}, r = 0, n = e; r < n.length; r++) {
    ...
    switch (i.stem) {
      ...
      case "measure-unit":
      case "unit":
        t.style = "unit", t.unit = Lt(i.options[0]);
        continue;
      case "compact-short":
      case "K":
      ...
      case "integer-width":
        ...
        i.options[0].replace(Ct, function(f, u, s, c, l, E) {
          if (u)
  ...
  for (var r = "", n = 0; n < e.length; n++) {
    ...
    if (i === "j") {
      for (var o = 0; n + 1 < e.length && e.charAt(n + 1) === i; )
        o++, n++;
      var a = 1 + (o & 1), h = o < 2 ? 1 : 3 + (o >> 1), f = "a", u = Dt(t);
      for ((u == "H" || u == "k") && (h = 0); h-- > 0; )
        r += f;
      for (; a-- > 0; )
        r = u + r;
...
var ee, Gt = new RegExp("^".concat(Xe.source, "*")), Ft = new RegExp("".concat(Xe.source, "*$"));
function p(e, t) {
  return {
    start: e,
    end: t
...
var jt = !!String.prototype.startsWith && "_a".startsWith("a", 1), Vt = !!String.fromCodePoint, Xt = !!Object.fromEntries, kt = !!String.prototype.codePointAt, zt = !!String.prototype.trimStart, Wt = !!String.prototype.trimEnd, Zt = !!Number.isSafeInteger, Qt = Zt ? Number.isSafeInteger : function(e) {
  return typeof e == "number" && isFinite(e) && Math.floor(e) === e && Math.abs(e) <= 9007199254740991;
}, he = !0;
try {
  var qt = Qe("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
...
var le;
if (he) {
  var Ae = Qe("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
  le = function(t, r) {
    var n;
    Ae.lastIndex = r;
    var i = Ae.exec(t);
...
var Kt = (
  ...
  function() {
    ...
    return e.prototype.parse = function() {
      ...
      var t = this.offset();
      for (this.bump(); !this.isEOF() && er(this.char()); )
        this.bump();
        ...
        case "time": {
          ...
          if (u && Be(u == null ? void 0 : u.style, "::", 0)) {
            ...
            if (h === "number") {
              ...
              var M = y;
              this.locale && (M = Ut(y, this.locale));
              var l = {
                type: N.dateTime,
                pattern: M,
      ...
      return {
        val: {
          ...
          tokens: n,
          location: r,
          parsedOptions: this.shouldParseSkeletons ? Rt(n) : {}
        },
        err: null
      };
...
function te(e, t) {
  var r = t && t.cache ? t.cache : hr, n = t && t.serializer ? t.serializer : sr, i = t && t.strategy ? t.strategy : ir;
  return i(e, {
    cache: r,
    serializer: n
  });
...
function ir(e, t) {
  var r = e.length === 1 ? Je : Ye;
  return be(e, this, r, t.cache.create(), t.serializer);
}
function or(e, t) {
  return be(e, this, Ye, t.cache.create(), t.serializer);
}
function ar(e, t) {
...
function k(e, t, r, n, i, o, a) {
  ...
  for (var h = [], f = 0, u = e; f < u.length; f++) {
    ...
    if (Re(s)) {
      var E = typeof s.style == "string" ? n.number[s.style] : Ve(s.style) ? s.style.parsedOptions : void 0;
...
const H = {}, xr = (e, t, r) => r && (t in H || (H[t] = {}), e in H[t] || (H[t][e] = r), r), Ke = (e, t) => {
  if (t == null) return;
  if (t in H && e in H[t])
    return H[t][e];
  const r = Y(t);
