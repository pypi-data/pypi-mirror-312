...
struct mjtEnableBit {
  ...
  static constexpr auto values = std::array{
    ...
    std::make_pair("mjENBL_NATIVECCD", ::mjtEnableBit::mjENBL_NATIVECCD),
...
struct mjtMeshInertia {
  ...
  static constexpr auto values = std::array{
    std::make_pair("mjINERTIA_CONVEX", ::mjtMeshInertia::mjINERTIA_CONVEX),
    std::make_pair("mjINERTIA_EXACT", ::mjtMeshInertia::mjINERTIA_EXACT),
    std::make_pair("mjINERTIA_LEGACY", ::mjtMeshInertia::mjINERTIA_LEGACY)};
};
