...
class InstanceTypeQueryOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["operator", "options", "all", "id", "region", "zone", "name", "cpu", "accelerator", "ram", "storage", "network", "price", "availability", "type", "billing_granularity", "provider", "reference_id", "attributes_hash"]
