...
class JobApi:
    ...
    def create_job(
        ...
        Endpoint for creating a new Job.  Args:     job_request(CreateJobRequest): parameters of the Job needed to be created,     request(Request): HTTP request  Returns:     CreateJobSuccess: if the Job is created successfully  Raises:     IncorrectCreateJobParameterError: if there is a missing parameter,     InsufficientCreditError: if organization's credit is insufficient,     InstanceTypeNotFoundError: if the Instance type is not found.
