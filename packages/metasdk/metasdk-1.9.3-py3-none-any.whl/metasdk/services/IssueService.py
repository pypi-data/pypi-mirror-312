...
class IssueService:
    ...
    def change_issue_status(self, issue_id: int, status_id: str):
        """
    ...
    def pending_issue(self, issue_id: int):
        """
    ...
    def in_progress_issue(self, issue_id: int):
        """
        Взять в работу
        :param issue_id: int
        """
    ...
    def reject_issue(self, issue_id: int):
        """
        Отклонить задачу
        :param issue_id: int
        """
    ...
    def clarification_issue(self, issue_id: int):
        """
        Уточнение
        :param issue_id: int
        """
    ...
    def done_issue(self, issue_id: int):
        """
    ...
    def add_issue_msg(self, issue_id: int, msg: str):
        self.__metadb.update("""
    ...
    def change_issue_status_secure(self, issue_id: int, status_id: str):
        if status_id not in IssueStatus:
            raise BadParametersError(f"Status id should be one of {IssueStatus._member_map_}")
    ...
    def create_issue(self, issue: IssueCreateItem) -> int:
        ...
        ticket_id = self.__metadb.query(query, {
            ...
            "last_user_id": self.auth_user_info["auth_user_id"],
    ...
    def get_issues(
        ...
        watcher_users: Optional[list[int]] = [],
    ) -> list[IssueGetItem]:
        """
