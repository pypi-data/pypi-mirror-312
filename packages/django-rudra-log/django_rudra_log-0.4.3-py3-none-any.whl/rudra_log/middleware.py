...
class LoggingMiddleware:
    ...
    async def __call__(self, request: HttpRequest):
        ...
        try:
            ...
            # handle exception here instead of in process_exception so that we can catch exceptions of other middlewares as well.
            # because Django middleware operates in two phases: process_request (before the view is called) and process_response/process_exception (after the view or earlier middleware returns).
