...
from sincpro_payments_sdk.apps.cybersource import Feature, cybersource
...
class CommandCreatePaymentMethod(BaseModel):
    card_number: str
    month: str
    year: str


class ResponseCreatePaymentMethod(BaseModel):
    id: str
    status: str
