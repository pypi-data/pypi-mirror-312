...
@cfunc(types.void(types.CPointer(types.CPointer(types.float64)), # targets
                  ...
                  types.CPointer(types.size_t),                  # location map
                  types.CPointer(types.size_t),                  # total sizes
                  types.CPointer(types.size_t),                  # field sizes
                  types.float64, types.float64, types.size_t))   # det(J), weight, element index
...
#         {
#            size_t ndof = totalSizes[0];
#            size_t ndofpadded = totalSizes[1];
#            
#            double* N = shapes[0];
