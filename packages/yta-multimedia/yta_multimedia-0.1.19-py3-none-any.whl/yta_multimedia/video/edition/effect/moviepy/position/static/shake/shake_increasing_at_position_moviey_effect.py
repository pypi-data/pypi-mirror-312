...
#     by time.
#     """
#     def apply(self, position: Union[Position] = Position.RANDOM_INSIDE):
#         """
...
#     def apply_over_video(self, background_video: Union[str, VideoFileClip, CompositeVideoClip, ImageClip, ColorClip], position: Union[Position] = Position.RANDOM_INSIDE):
#         """
...
#             raise Exception('Provided "position" is not a valid Position instance.')
...
#         effect = self.video.with_position(lambda t: shake_increasing_movement(t, position[0], position[1])).with_start(0).with_duration(self.video.duration)
