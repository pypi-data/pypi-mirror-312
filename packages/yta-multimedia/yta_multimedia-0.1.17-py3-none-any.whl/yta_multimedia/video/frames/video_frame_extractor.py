...
class VideoFrameExtractor:
    ...
    def get_frame_by_time(video: VideoClip, t: float = 0.0, output_filename: Union[str, None] = None):
        ...
        """
        frame = VideoFrameExtractor.get_frames_by_time(video, [t])
    ...
    def get_frame(video, mode: FrameExtractionType = FrameExtractionType.FRAME_NUMBER, t: Union[float, int] = 0):
        ...
        # I recommend you to ensure that the 'video' is valid
        # and its duration has been correctly read. There is
        # a bug that could let you have a video with a greater
        # duration than the real one. Consider that and check
        # our 'verify_and_update_duration' method.
        frames = VideoFrameExtractor.get_all_frames()
