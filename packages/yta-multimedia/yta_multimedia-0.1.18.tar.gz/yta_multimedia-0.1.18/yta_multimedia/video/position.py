...
class Position(Enum):
    ...
    def get_moviepy_position_center(self, scene_size: tuple = (1920, 1080)):
        ...
        if self == Position.RANDOM_INSIDE:
            return Position.get_random_inside().get_moviepy_position_center()
        elif self == Position.RANDOM_OUTSIDE:
            return Position.get_random_outside().get_moviepy_position_center()
    ...
    def to_coordinate(position: 'Position'):
        ...
        position = position.get_moviepy_position_center()
