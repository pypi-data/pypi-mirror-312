...
class TFunctionSetPosition:
    ...
    """
    # TODO: Here is an attempt of decorator, but I need
    # more parameters that I don't receive
    def apply_position_normal_shaking(func):
        @wraps(func)
        def wrapper(*args, **kwargs):
            ...
            # return shake_movement(t, x, y)

            # TODO: This is just to check the print
    ...
    def linear_with_normal_shaking(t: float, duration: float, initial_position: tuple, final_position: tuple, rate_func: type = RateFunction.linear):
        ...
        print('here in linear_with_normal_shaking')
