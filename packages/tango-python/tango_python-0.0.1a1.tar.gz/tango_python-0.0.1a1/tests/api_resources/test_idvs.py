...
class TestIdvs:
    ...
    def test_method_retrieve(self, client: Tango) -> None:
        idv = client.idvs.retrieve(
            "contract_award_unique_key",
        )
        assert_matches_type(Idv, idv, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Tango) -> None:
        response = client.idvs.with_raw_response.retrieve(
            "contract_award_unique_key",
        )
    ...
    def test_streaming_response_retrieve(self, client: Tango) -> None:
        with client.idvs.with_streaming_response.retrieve(
            "contract_award_unique_key",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Tango) -> None:
        with pytest.raises(
            ...
            client.idvs.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Tango) -> None:
        idv = client.idvs.list()
        assert_matches_type(IdvListResponse, idv, path=["response"])
    ...
    def test_raw_response_list(self, client: Tango) -> None:
        response = client.idvs.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Tango) -> None:
        with client.idvs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncIdvs:
    ...
    async def test_method_retrieve(self, async_client: AsyncTango) -> None:
        idv = await async_client.idvs.retrieve(
            "contract_award_unique_key",
        )
        assert_matches_type(Idv, idv, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTango) -> None:
        response = await async_client.idvs.with_raw_response.retrieve(
            "contract_award_unique_key",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        idv = await response.parse()
        assert_matches_type(Idv, idv, path=["response"])

    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncTango) -> None:
        async with async_client.idvs.with_streaming_response.retrieve(
            "contract_award_unique_key",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTango) -> None:
        with pytest.raises(
            ...
            await async_client.idvs.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncTango) -> None:
        idv = await async_client.idvs.list()
        assert_matches_type(IdvListResponse, idv, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncTango) -> None:
        response = await async_client.idvs.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncTango) -> None:
        async with async_client.idvs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
