...
from tango import Tango, AsyncTango, APIResponseValidationError
...
def _get_open_connections(client: Tango | AsyncTango) -> int:
...
class TestTango:
    ...
    def test_multipart_repeating_array(self, client: Tango) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Tango) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Tango) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Tango) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("tango._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/api/schema/").mock(side_effect=retry_handler)
    ...
    @mock.patch("tango._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Tango, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.schemas.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        self, client: Tango, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.schemas.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncTango:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTango) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncTango) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTango) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTango) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        ...
        response = await client.schemas.with_raw_response.retrieve()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTango, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.schemas.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.schemas.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from tango._utils import asyncify
        from tango._base_client import get_platform 
