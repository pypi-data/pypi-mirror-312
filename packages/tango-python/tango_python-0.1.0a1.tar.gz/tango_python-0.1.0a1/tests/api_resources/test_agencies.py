...
class TestAgencies:
    ...
    def test_method_retrieve(self, client: Tango) -> None:
        agency = client.agencies.retrieve(
            "code",
        )
        assert_matches_type(Agency, agency, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Tango) -> None:
        response = client.agencies.with_raw_response.retrieve(
            "code",
        )
    ...
    def test_streaming_response_retrieve(self, client: Tango) -> None:
        with client.agencies.with_streaming_response.retrieve(
            "code",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Tango) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `code` but received ''"):
            client.agencies.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_list(self, client: Tango) -> None:
        agency = client.agencies.list()
        assert_matches_type(AgencyListResponse, agency, path=["response"])
    ...
    def test_raw_response_list(self, client: Tango) -> None:
        response = client.agencies.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Tango) -> None:
        with client.agencies.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncAgencies:
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTango) -> None:
        response = await async_client.agencies.with_raw_response.retrieve(
            "code",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTango) -> None:
        async with async_client.agencies.with_streaming_response.retrieve(
            "code",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTango) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `code` but received ''"):
            await async_client.agencies.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncTango) -> None:
        agency = await async_client.agencies.list()
        assert_matches_type(AgencyListResponse, agency, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncTango) -> None:
        response = await async_client.agencies.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncTango) -> None:
        async with async_client.agencies.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
