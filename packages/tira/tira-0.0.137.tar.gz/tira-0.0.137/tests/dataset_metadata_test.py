...
class DatasetMetadataTest(unittest.TestCase):
    def test_error_message_for_non_existing_dataset(self):
        ...
        tira = Client(tira_cache_dir=CACHE_DIR_WITH_DATASETS, base_url="https://127.0.0.1:8080", failsave_retries=0)
    ...
    def test_ir_dataset_with_tira_id(self):
        tira = Client(base_url="https://127.0.0.1:8080", failsave_retries=0, tira_cache_dir=CACHE_DIR_WITH_DATASETS)
    ...
    def test_ir_dataset_with_ir_datasets_id(self):
        tira = Client(base_url="https://127.0.0.1:8080", failsave_retries=0, tira_cache_dir=CACHE_DIR_WITH_DATASETS)
        expected = "clueweb09-en-trec-web-2009-20230107-training"
