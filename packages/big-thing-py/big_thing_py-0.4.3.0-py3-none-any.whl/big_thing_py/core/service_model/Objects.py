...
class recorder(Skill):
    ...
    @MXClassproperty
    def descriptor(cls) -> str:
        return 'The Recorder skill allows for interacting with devices that serve as recorders'
    ...
    class Functions:
        @dataclass
        class startRecord(SkillFunction):
            @MXClassproperty
            def descriptor(cls) -> str:
                return 'Start record'
            ...
            class Arguments:
                @dataclass
                class fileName(SkillFunctionArgument):
                    @MXClassproperty
                    def descriptor(cls) -> str:
        ...
        @dataclass
        class stopRecord(SkillFunction):
            @MXClassproperty
            def descriptor(cls) -> str:
                return 'Stop recording and save the audio file'
