...
class KeepFriends(Crawler):
    base_url: str = 'https://pt.keepfrds.com'
    ...
    def get_user(self) -> User:
        ...
        user_id_element = find_element(html, '//a[contains(@href, "userdetails.php")]')
        title_element = find_element(html, '//table[@id="info_block"]//td[@class="bottom"]')
    ...
    def get_torrents(self, pages: int = 1) -> List[Torrent]:
        ...
        for page in range(pages):
            ...
            html = etree.HTML(response.text) # pylint: disable=c-extension-no-member
            _, *rows = html.xpath('//table[@class="torrents"]/tr')
