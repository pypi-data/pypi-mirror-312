...
class EntityDefinition(InteractiveHALResponse):
    ...
    def create_attribute(self, attribute_name: str, type:AttributeType, *, attribute_description: str=None, unique: bool=False, required: bool=False, natural_id:bool=False):
        payload = {
            "name" : attribute_name,
...
class AttributeDefinition(InteractiveHALResponse):
    ...
    def patch(self, attribute_name :str=None, attribute_description :str=None, attribute_type :AttributeType=None, required :bool=None, unique :bool=None):
        payload = {}
    ...
    def __str__(self) -> str:
        ...
        return f"[Attribute {self.name}] type={self.type.name} | required={self.required} | unique={self.unique} | exact_search={exact} | prefix_search={prefix} | natural_id={self.natural_id}"
