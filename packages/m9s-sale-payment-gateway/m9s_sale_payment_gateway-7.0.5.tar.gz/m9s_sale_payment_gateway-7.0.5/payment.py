...
class Payment(ModelSQL, ModelView):
    ...
    amount = fields.Numeric(
        'Amount', required=True, digits='currency',
    ...
    amount_consumed = fields.Function(
        fields.Numeric(
            'Amount Consumed', digits='currency',
        ), 'get_amount'
    )
    amount_available = fields.Function(
        fields.Numeric(
            'Amount Remaining', digits='currency',
        ), 'get_amount'
    )
    amount_authorized = fields.Function(
        fields.Numeric(
            'Amount Authorized', digits='currency',
        ), 'get_amount'
    )
    amount_captured = fields.Function(
        fields.Numeric(
            'Amount Captured', digits='currency',
        ), 'get_amount'
    )
    amount_refunded = fields.Function(
        fields.Numeric(
            'Amount Refunded', digits='currency',
        ), 'get_amount'
    )
