...
class ResourceManager(ABC):
    ...
    async def _download_task(
        ...
        *,
        ...
        if download_destination.exists():
            ...
            await self._finished_download(resource)
            return
        else:
        ...
        async with self._download_limiter:
            try:
                ...
                with register_reporter(
                    ...
                    shutil.move(
                        src=temp_destination, dst=download_destination.absolute()
                    )
    ...
    async def _finished_download(self, resource: db.Resource) -> None:
