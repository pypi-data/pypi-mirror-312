...
from libqcanvas.util.dev_failed_resource_list import FailedResourcesList
...
class ResourceScanner:
    ...
    async def _extract_content_resources(
        ...
        return ExtractedResources(
            content=ContentItemReference(content=content),
    ...
    async def _extract_resource(
        ...
        try:
            ...
            if await self._failed_resources.did_extraction_fail(file_id):
