...
string: Decoder_1[str] = ObjectExpr12()

class ObjectExpr13(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr13()

class ObjectExpr16(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow14(__unit: None=None) -> str:
                return out_arg

            def _arrow15(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow14, _arrow15)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr16()

class ObjectExpr17(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr17()

class ObjectExpr20(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow18(__unit: None=None) -> int8:
                return out_arg

            def _arrow19(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow18, _arrow19)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr20()
