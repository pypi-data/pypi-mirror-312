...
from ..fable_modules.fable_library.array_ import (remove_in_place, add_range_in_place)
from ..fable_modules.fable_library.list import (iterate as iterate_1, FSharpList)
from ..fable_modules.fable_library.map import (of_seq, try_find as try_find_1)
from ..fable_modules.fable_library.option import (default_arg, value as value_3)
from ..fable_modules.fable_library.reflection import (TypeInfo, class_type)
from ..fable_modules.fable_library.seq import (map, sort_by, head, last, iterate, try_find, find, exists, filter, max_by, empty)
...
from ..fable_modules.fable_library.util import (compare_primitives, IEnumerable_1, number_hash, ignore, get_enumerator, dispose, equals, safe_hash, clear)
...
class FsWorksheet:
    ...
    def Columns(self, __unit: None=None) -> IEnumerable_1[FsColumn]:
        ...
        def mapping(tupled_arg: tuple[int, IEnumerable_1[FsCell]]) -> FsColumn:
            ...
            def _arrow153(__unit: None=None, tupled_arg: Any=tupled_arg) -> FsRangeAddress:
                ...
                cells_1: IEnumerable_1[FsCell] = sort_by(projection_1, tupled_arg[1], ObjectExpr150())
                def _arrow151(__unit: None=None) -> int:
                    c_2: FsCell = head(cells_1)
                    return c_2.RowNumber

                def _arrow152(__unit: None=None) -> int:
                    c_3: FsCell = last(cells_1)
                    return c_3.RowNumber

                tupled_arg_1 = (FsAddress__ctor_Z37302880(_arrow151(), column_index), FsAddress__ctor_Z37302880(_arrow152(), column_index))
                return FsRangeAddress__ctor_7E77A4A0(tupled_arg_1[0], tupled_arg_1[1])

            return FsColumn(_arrow153(), self_1.CellCollection)
        ...
        class ObjectExpr155:
            ...
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow154(x: int, y: int) -> bool:
                    return x == y
        ...
        return map(mapping, group_by(projection, FsCellsCollection__GetCells(self_1._cells), ObjectExpr155()))
    ...
    def Copy(self, __unit: None=None) -> FsWorksheet:
        ...
        def _arrow156(__unit: None=None) -> Array[FsRow]:
            n: Array[FsRow] = []
        ...
        def _arrow157(__unit: None=None) -> Array[FsTable]:
            n_1: Array[FsTable] = []
        ...
        return FsWorksheet(self_1.Name, _arrow156(), _arrow157(), fcc)
    ...
    def RemoveRowAt(self, row_index: int) -> None:
        ...
        with get_enumerator(filter(predicate, self_1._rows)) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                ignore(remove_in_place(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), self_1._rows, ObjectExpr158()))
    ...
    def SortRows(self, __unit: None=None) -> None:
        ...
        sorted: Array[FsRow] = list(sort_by(projection, self_1._rows, ObjectExpr159()))
        clear(self_1._rows)
    ...
    def GetMaxRowIndex(self, __unit: None=None) -> FsRow:
        ...
        return max_by(projection, self_1.Rows, ObjectExpr160())
    ...
    def RescanRows(self, __unit: None=None) -> None:
        ...
        rows: Any = of_seq(map(mapping, self_1._rows), ObjectExpr161())
        ...
        class ObjectExpr163:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow162(x_1: int, y_1: int) -> bool:
                    return x_1 == y_1
        ...
        iterate(action_1, group_by(projection, FsCellsCollection__GetCells(self_1._cells), ObjectExpr163()))
...
FsWorksheet_reflection = _expr164
