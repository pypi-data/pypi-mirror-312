...
from .fable_modules.fable_library.array_ import (iterate as iterate_1, iterate_indexed)
...
from .fable_modules.fable_openpyxl.openpyxl import (Worksheet, Table, Workbook, Cell)
from .FsSpreadsheet.Cells.fs_cell import FsCell
from .FsSpreadsheet.Cells.fs_cells_collection import FsCellsCollection__GetCells
from .FsSpreadsheet.fs_address import (FsAddress__get_RowNumber, FsAddress__get_ColumnNumber)
from .FsSpreadsheet.fs_worksheet import FsWorksheet
from .FsSpreadsheet.Tables.fs_table import FsTable
...
def from_fs_worksheet(parent: Workbook, fs_ws: FsWorksheet) -> Worksheet:
    ...
    def action_1(cell: FsCell, parent: Any=parent, fs_ws: Any=fs_ws) -> None:
        ...
        ignore(py_ws.cell(FsAddress__get_RowNumber(cell.Address), FsAddress__get_ColumnNumber(cell.Address), some(py_cell)))

    iterate(action_1, FsCellsCollection__GetCells(fs_ws.CellCollection))
    return py_ws
