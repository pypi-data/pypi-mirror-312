...
from ..fable_modules.fable_library.array_ import (map, remove_in_place, try_find as try_find_1, collect)
from ..fable_modules.fable_library.option import (value as value_1, default_arg)
from ..fable_modules.fable_library.reflection import (TypeInfo, class_type)
from ..fable_modules.fable_library.seq import (exists, iterate, try_item, try_find)
from ..fable_modules.fable_library.string_ import (to_fail, printf)
from ..fable_modules.fable_library.types import Array
from ..fable_modules.fable_library.util import (IEnumerable_1, ignore, equals, safe_hash, IDisposable)
...
class FsWorkbook(IDisposable):
    ...
    def RemoveWorksheet(self, name: str) -> None:
        self_1: FsWorkbook = self
        def _arrow147(__unit: None=None) -> FsWorksheet:
            try: 
                def _arrow146(ws: FsWorksheet) -> bool:
                    return ws.Name == name

                return default_arg(try_find_1(_arrow146, self_1._worksheets), None)
        ...
        ignore(remove_in_place(_arrow147(), self_1._worksheets, ObjectExpr148()))
...
FsWorkbook_reflection = _expr149
