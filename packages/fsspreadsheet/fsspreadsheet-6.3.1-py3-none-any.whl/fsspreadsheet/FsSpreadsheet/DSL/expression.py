...
def _expr165(gen0: TypeInfo) -> TypeInfo:
...
OptionalSource_1_reflection = _expr165
...
def _expr166(gen0: TypeInfo) -> TypeInfo:
...
RequiredSource_1_reflection = _expr166
...
def _expr167(gen0: TypeInfo) -> TypeInfo:
...
ExpressionSource_1_reflection = _expr167
