...
from ...fable_modules.fable_library.map_util import (add_to_set, add_to_dict, get_item_from_dict, remove_from_dict)
from ...fable_modules.fable_library.option import (value as value_2, default_arg)
from ...fable_modules.fable_library.range import range_big_int
from ...fable_modules.fable_library.reflection import (TypeInfo, class_type)
from ...fable_modules.fable_library.seq import (initialize, delay, collect, singleton, reduce, map, iterate_indexed, iterate, length, max, find, try_find, try_pick, choose, to_list, exists)
from ...fable_modules.fable_library.string_ import replace
from ...fable_modules.fable_library.util import (equals, IEnumerable_1, int32_to_string, ignore, compare_primitives, get_enumerator)
...
class FsTable(FsRangeBase):
    ...
    def GetFields(self, cells_collection: FsCellsCollection) -> IEnumerable_1[FsTableField]:
        this: FsTable = self
        def _arrow137(i: int) -> FsTableField:
            return this.GetFieldAt(i, cells_collection)

        return initialize(FsRangeBase__ColumnCount(this), _arrow137)
    ...
    def GetColumns(self, cells_collection: FsCellsCollection) -> IEnumerable_1[FsColumn]:
        this: FsTable = self
        def _arrow139(__unit: None=None) -> IEnumerable_1[FsColumn]:
            def _arrow138(i: int) -> IEnumerable_1[FsColumn]:
            ...
            return collect(_arrow138, range_big_int(FsAddress__get_ColumnNumber(FsRangeAddress__get_FirstAddress(FsRangeBase__get_RangeAddress(this))), 1, FsAddress__get_ColumnNumber(FsRangeAddress__get_LastAddress(FsRangeBase__get_RangeAddress(this)))))

        return delay(_arrow139)

    def GetRows(self, cells_collection: FsCellsCollection) -> IEnumerable_1[FsRow]:
        this: FsTable = self
        def _arrow141(__unit: None=None) -> IEnumerable_1[FsRow]:
            def _arrow140(i: int) -> IEnumerable_1[FsRow]:
            ...
            return collect(_arrow140, range_big_int(FsAddress__get_RowNumber(FsRangeAddress__get_FirstAddress(FsRangeBase__get_RangeAddress(this))), 1, FsAddress__get_RowNumber(FsRangeAddress__get_LastAddress(FsRangeBase__get_RangeAddress(this)))))
    ...
    def Field(self, name: str, cells_collection: FsCellsCollection) -> FsTableField:
        ...
        if match_value is None:
            def _arrow143(__unit: None=None) -> int:
                ...
                return 0 if (length(s) == 0) else max(s, ObjectExpr142())

            def _arrow144(__unit: None=None) -> FsRangeAddress:
            ...
            new_field: FsTableField = FsTableField__ctor_726EFFB(name, _arrow143() + 1, FsRangeColumn__ctor_6A2513BC(_arrow144()), None, None)
