...
#********************************************* TAB definitions
                        ...
                        for f in range(len(INP.imList[c])):
                            for k in range(len(INP.imList[c][f])):
                                if INP.imEx[c][f][k]: 
                                    ...
                                    break
                    OUT.imageFileMin=None
                    if  ITE.Step in [StepTypes.piv,StepTypes.disp,StepTypes.spiv]:
                        for c in range(len(INP.imListMin)):
                            for f in range(len(INP.imListMin[c])):
                                if INP.imListMin[c][f]:
                                    OUT.imageFileMin=INP.imListMin[c][f]
                                    break
    ...
    def IOVinheritance(self,ind_slave,ind_master):
...
#*************************************************** Link and copy
    ...
    def button_step_inherit_action(self):
        self.copy_link_action(self.ui.button_step_inherit,lambda isl,ima: self.IOVinheritance(isl,ima),menuTitle='Copy input/output data from...', message='No process step available!', stepListType=1)
