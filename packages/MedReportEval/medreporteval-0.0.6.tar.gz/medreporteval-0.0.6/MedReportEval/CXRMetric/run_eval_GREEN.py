...
COLS = ["bleu_1", "bleu_4", "meteor_score", "rouge_l", "bertscore"] ###
...
def calc_metric(gt_csv, pred_csv, out_csv, use_idf=False): # TODO: support single metrics at a time
    ...
    # set output color to blue
    print("\033[94m")
    print("compute result: ", pos_f1, pos_f1_five, neg_f1, neg_f1_five, label_neg_f1)


    # computing mean hallucination proportion
    hallu_prop = hallucination_prop(pred)
    print("hallucination proportion: ", hallu_prop)
