...
CHEXBERT_PATH = '/net/projects/chacha/cxr_eval/models/chexbert.pth'
RADGRAPH_PATH = '/net/projects/chacha/cxr_eval/models/radgraph.tar.gz'

REPORT_COL_NAME = "report"
STUDY_ID_COL_NAME = "study_id"
COLS = ["bleu_1", "bleu_4", "meteor_score", "rouge_l"]
...
def calc_metric(gt_csv, pred_csv, out_csv, use_idf=False, if_bert=False, if_radgraph=False):
