...
import numpy as np
import time
from CXRMetric.utils_GREEN import (
    gather_processes,
    make_prompt,
    clean_responses,
...
class Inferer:
    def __init__(
        ...
        tokenizer=None,
        model_name="",
        output_dir="/net/projects/chacha/yuyang/CXR-Report-Metric/CXRMetric/results",
        num_examples=None,
        batch_size=10,
        max_length=2048,
    ):
    ...
    def process_results(self):
        ...
        path = self.output_dir + f"/results_green{self.model_name}.csv"
...
if __name__ == "__main__":
    ...
    compute(model_name, refs, hyps, output_dir="/net/projects/chacha/yuyang/CXR-Report-Metric/CXRMetric/results")
