...
Generated by
[mypy-boto3-builder 8.4.2](https://github.com/youtype/mypy_boto3_builder).
...
- `types-aioboto3[full]` - Type annotations for all 387 services in one package
  (recommended).
- `types-aioboto3[all]` - Type annotations for all 387 services in separate
  packages.
