...
from CaptDeviceControl.constants.dwfconstants import hdwfNone, acqmodeRecord, DwfStateConfig, DwfStatePrefill, DwfStateArmed, \
...
def on_ad2_set_acquisition_changed(record):
    if record:
