...
class ZettaparkClientExceptionMessages:
    ...
    @staticmethod
    def PLAN_CREATE_DYNAMIC_TABLE_FROM_DDL_DML_OPERATIONS() -> ZettaparkCreateDynamicTableException:
    ...
    @staticmethod
    def PLAN_CREATE_DYNAMIC_TABLE_FROM_SELECT_ONLY() -> ZettaparkCreateDynamicTableException:
        return ZettaparkCreateDynamicTableException(
