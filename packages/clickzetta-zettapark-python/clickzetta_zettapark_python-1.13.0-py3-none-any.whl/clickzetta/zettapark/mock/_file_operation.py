...
from clickzetta.zettapark.mock._snowflake_to_pandas_converter import CONVERT_MAP
from clickzetta.zettapark.types import DecimalType, StringType
...
def read_file(
    ...
    try:
        ...
        if stage_location and stage_location[0] != "@":
            raise ZettaparkSQLException("SQL compilation error")
