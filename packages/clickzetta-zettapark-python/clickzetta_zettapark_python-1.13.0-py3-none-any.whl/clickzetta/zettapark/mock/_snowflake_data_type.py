...
# pandas is an optional requirement for local test, so make zettapark compatible with env where pandas
...
class ColumnEmulator(PandasSeriesType):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        # if we do sub-field v["a"], zettapark python return ['null', None] instead of [None, None]
