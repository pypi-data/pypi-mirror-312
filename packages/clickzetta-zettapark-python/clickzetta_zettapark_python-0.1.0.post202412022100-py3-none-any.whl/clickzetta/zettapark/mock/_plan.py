...
from clickzetta.zettapark.mock._window_utils import (
    EntireWindowIndexer,
    RowFrameIndexer,
...
if TYPE_CHECKING:
    from clickzetta.zettapark.mock._analyzer import MockAnalyzer

import clickzetta.zettapark.mock._file_operation as mock_file_operation
...
from clickzetta.zettapark._internal.analyzer.binary_plan_node import Join
...
from clickzetta.zettapark.mock._functions import _MOCK_FUNCTION_IMPLEMENTATION_MAP
from clickzetta.zettapark.mock._select_statement import (
    MockSelectable,
...
from clickzetta.zettapark.mock._snowflake_data_type import (
    ColumnEmulator,
    ColumnType,
    TableEmulator,
)
from clickzetta.zettapark.mock._util import (
...
def handle_function_expression(
    ...
    try:
        original_func = getattr(
            importlib.import_module("clickzetta.zettapark.functions"), func_name
        )
    ...
    *,
    ...
    if isinstance(exp, (UnresolvedAttribute, Attribute)):
        ...
        try:
            ...
            raise ZettaparkSQLException(f"[Local Testing] invalid identifier {exp.name}")
    ...
    if isinstance(exp, RegExp):
        ...
        try:
            ...
            raise ZettaparkSQLException(f"Invalid regular expression {raw_pattern}")
