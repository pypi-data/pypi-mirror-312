...
class PydanticV2Error(Exception):
    pass
    ...
    def generate_fragments(
        ...
        while len(processed) < len(definitions):
            ...
            if len(current_to_process) == len(next_to_process):
                ...
                raise PydanticV2Error("Cyclic fragment dependency detected")
