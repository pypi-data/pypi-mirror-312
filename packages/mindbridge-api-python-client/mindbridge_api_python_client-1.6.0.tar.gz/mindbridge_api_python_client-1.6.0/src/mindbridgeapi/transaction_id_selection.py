...
from mindbridgeapi.generated_pydantic_model.model import ApiTransactionIdSelectionRead
from mindbridgeapi.generated_pydantic_model.model import Type13 as _TransactionIdType
