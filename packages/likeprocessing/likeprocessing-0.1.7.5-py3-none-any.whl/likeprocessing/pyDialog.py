...
class LineEdit(Boite):
    ...
    def draw(self):
        if self.visible:
            ...
            if self.focus:
                processing.title(
                    self.texte.manager.left + " " + self.texte.manager.right + " " + str(self.texte._width_max))
        ...
        if self.is_disabled is False:
            ...
            if self.mouseOn and click is True:
                ...
                if not self.multi:
                    ...
                    self.texte.set_cursor_pos(self.texte.posxy_to_cursor_pos(x - self.parent.x - self.x, y - self.parent.y - self.y))
        else:
            self.focus = False
