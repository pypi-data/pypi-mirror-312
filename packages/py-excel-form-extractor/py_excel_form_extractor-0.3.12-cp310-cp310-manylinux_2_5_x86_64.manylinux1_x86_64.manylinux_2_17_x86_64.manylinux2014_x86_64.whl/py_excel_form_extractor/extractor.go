...
//export extractor_ProductDetails_RepresentativeCompany_Get
func extractor_ProductDetails_RepresentativeCompany_Get(handle CGoHandle) *C.char {
	op := ptrFromHandle_extractor_ProductDetails(handle)
	return C.CString(op.RepresentativeCompany)
}

//export extractor_ProductDetails_RepresentativeCompany_Set
func extractor_ProductDetails_RepresentativeCompany_Set(handle CGoHandle, val *C.char) {
	op := ptrFromHandle_extractor_ProductDetails(handle)
	op.RepresentativeCompany = C.GoString(val)
}
...
func extractor_ProductDetails_RepresentativeSignature_Get(handle CGoHandle) *C.char {
	op := ptrFromHandle_extractor_ProductDetails(handle)
	return C.CString(op.RepresentativeSignature)
}
...
func extractor_ProductDetails_RepresentativeSignature_Set(handle CGoHandle, val *C.char) {
	op := ptrFromHandle_extractor_ProductDetails(handle)
	op.RepresentativeSignature = C.GoString(val)
}
