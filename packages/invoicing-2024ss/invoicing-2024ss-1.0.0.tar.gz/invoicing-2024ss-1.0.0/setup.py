...
setup(
  name = 'invoicing-2024ss',         #* Your package will have this name
  ...
  author_email = 'sueangss@gmail.com',  # Your email
  url = 'https://angsuesan@github.com',              # Homepage of your library (e.g. github or your website)
