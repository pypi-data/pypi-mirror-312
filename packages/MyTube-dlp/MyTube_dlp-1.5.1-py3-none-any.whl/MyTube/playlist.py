...
import yt_dlp
import tempfile
from .playlist_manager import PlaylistManager, PlaylistVideo
...
class Playlist:
	...
	@property
	def videos(self) -> PlaylistManager: return self._videos
	@property
	def raw_videos(self) -> list: return self._videos.arr
