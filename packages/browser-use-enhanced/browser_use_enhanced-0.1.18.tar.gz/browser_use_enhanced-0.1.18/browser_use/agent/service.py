...
class SearchGoogleAction(BaseModel):
    query: str = Field(..., description="The search query to enter")

class ClickElementAction(BaseModel):
    index: int = Field(..., description="The index of the element to click")
    num_clicks: int = Field(..., description="Number of times to click the element")
    xpath: str = Field(..., description="The xpath of the element to click")

class DoneAction(BaseModel):
    text: str = Field(..., description="Description of the completed action")
