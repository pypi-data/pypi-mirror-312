...
class SignalMgr:
    ...
    async def produce_signal_to_kafka(self, ksqldb_query_url, topic_name_signal, market, data_source, direction:Direction, side:Side, order_type:OrderType, price, tp, sl, position_size_in_percentage, percentage_of_position, topic_name_trade=None, view_name_trade=None, provider_trade_id=None, pos_idx=None, status_of_position:StatusOfTrade=None):
        ...
        try:
            await self.kafka_producer_manager.produce_message(
