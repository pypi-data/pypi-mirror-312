...
async def infer_job(reporter, dataset_cfg, output_dataset_cfg, params={}):
    """
...
class JobServer:
    ...
    async def run(req: FARequest, background_tasks: BackgroundTasks):
        ...
        return FAResponse(content=json.dumps({"code": "1", "message": "server job start"}), media_type="application/json")
