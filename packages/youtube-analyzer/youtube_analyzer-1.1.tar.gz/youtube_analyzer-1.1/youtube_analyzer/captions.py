    ...
    def content(self) -> str:
        ...
        try:
            ...
            if rep.status_code == 200:
                ...
                raise YoutubeAnalyzerExceptions("Não foi posível obter o conteúdo da legenda!")
...
class TradutionCaptions:
    ...
    def __convert_url_to_previous_format(url_srv3, tlang):
        """
        método privado para criar a url da legenda traduzida com  base nos requsitos da api....
        :param url_srv3: url original
        :param tlang: idioma destino
        :return: nova url
        """
