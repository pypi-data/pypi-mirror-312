...
async function activate(app, palette, restorer, statusBar, router) {
    ...
    if (router) {
        // 尝试获取路由信息的备选方案
        const currentPath = ((_a = router.current) === null || _a === void 0 ? void 0 : _a.path) ||
            ((_b = router.location) === null || _b === void 0 ? void 0 : _b.pathname) ||
            window.location.pathname;
        console.log('当前路由:', currentPath);
    }
    try {
        console.log('Initial route:', ((_c = router === null || router === void 0 ? void 0 : router.current) === null || _c === void 0 ? void 0 : _c.path) || 'Route not ready');
        // 插件其他初始化逻辑
        const projectId = localStorage.getItem('projectId');
        const projectData = await (0,_api_project__WEBPACK_IMPORTED_MODULE_3__.getProjectDetail)(projectId || '');
...
//# sourceMappingURL=lib_index_js.585d41e4186c59f503d6.js.map