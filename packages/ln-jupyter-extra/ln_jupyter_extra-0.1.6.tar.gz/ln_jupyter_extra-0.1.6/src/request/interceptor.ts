...
export const handlerRequest = (
  ...
  if (USREINFO.token) {
    ...
    window.location.replace(
      usercenter + '/login?redirect=' + window.location.origin
    );
  }
  return config as InternalAxiosRequestConfig<any>;
};
