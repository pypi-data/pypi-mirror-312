...
/* harmony import */ var _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @jupyterlab/apputils */ "webpack/sharing/consume/default/@jupyterlab/apputils");
/* harmony import */ var _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _widgets_createVersion__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./widgets/createVersion */ "./lib/widgets/createVersion.js");
/* harmony import */ var _widgets_version__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./widgets/version */ "./lib/widgets/version.js");
/* harmony import */ var _widgets_dataset__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./widgets/dataset */ "./lib/widgets/dataset.js");
/* harmony import */ var _widgets_time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./widgets/time */ "./lib/widgets/time.js");
/* harmony import */ var _widgets_log__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./widgets/log */ "./lib/widgets/log.js");
...
/* harmony import */ var _widgets_variable_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./widgets/variable/index */ "./lib/widgets/variable/index.js");
...
async function activate(app, palette, restorer, statusBar, router) {
    ...
    if (router) {
        // 尝试获取路由信息的备选方案
        const currentUrl = 'https://hero-dev.cnbita.com/jupyter/a13794918639071232868226/lab?nId=a13794788668076032978243';
        const queryString = currentUrl.split('?')[1];
        const urlParams = new URLSearchParams(queryString);
        const notebookProjectId = urlParams.get('nId') || '';
        if (!notebookProjectId) {
            _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.Notification.error('项目ID未获取到');
        }
        else {
            try {
                console.log('Initial route:', notebookProjectId || 'Route not ready');
                const projectData = await (0,_api_project__WEBPACK_IMPORTED_MODULE_2__.getProjectDetail)(notebookProjectId || '');
                const timeWidget = new _widgets_time__WEBPACK_IMPORTED_MODULE_3__["default"]();
                timeWidget.install(app);
                const sidebarWidget = new _widgets_version__WEBPACK_IMPORTED_MODULE_4__["default"]();
                sidebarWidget.install(app);
                const sidebarDataSet = new _widgets_dataset__WEBPACK_IMPORTED_MODULE_5__["default"]({ projectData });
                sidebarDataSet.install(app);
                const titleWidget = new _widgets_title__WEBPACK_IMPORTED_MODULE_6__["default"]({ projectData });
                titleWidget.install(app);
                const createVersionBtn = new _widgets_createVersion__WEBPACK_IMPORTED_MODULE_7__["default"](app);
                createVersionBtn.install(app);
                const logMonitor = new _widgets_log__WEBPACK_IMPORTED_MODULE_8__["default"]();
...
const plugins = [lnPlugin, ..._widgets_variable_index__WEBPACK_IMPORTED_MODULE_9__["default"]];
...
//# sourceMappingURL=lib_index_js.cb2936ba3fff8e3cc4dc.js.map