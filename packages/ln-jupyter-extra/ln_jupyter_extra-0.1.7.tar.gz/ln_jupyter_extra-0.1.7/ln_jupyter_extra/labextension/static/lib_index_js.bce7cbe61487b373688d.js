...
async function activate(app, palette, restorer, statusBar, router) {
    ...
    if (router) {
        // 尝试获取路由信息的备选方案
        const currentUrl = 'https://hero-dev.cnbita.com/jupyter/a13797103798317056769429/lab';
        const projectId = extractProjectId(currentUrl);
        console.log('Extracted projectId:', currentUrl);
        console.log('Extracted projectId:', projectId);
    }
    try {
        // console.log('Initial route:', projectId || 'Route not ready');
        // 插件其他初始化逻辑
...
//# sourceMappingURL=lib_index_js.bce7cbe61487b373688d.js.map