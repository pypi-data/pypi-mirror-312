...
### Helper functions
    ...
    def box3D(self,W,H):
        ...
        self.addWall(label='South', shape=rect_wall.move( to = (W,0,0), by = (  0,  0)), front=0, back=1)
        self.addWall(label='East',  shape=rect_wall.move( to = (W,W,0), by = ( 90,  0)), front=0, back=1)
        self.addWall(label='North' ,shape=rect_wall.move( to = (0,W,0), by = (180,  0)), front=0, back=1)
        self.addWall(label='West',  shape=rect_wall.move( to = (0,0,0), by = (270,  0)), front=0, back=1)
        self.addWall(label='top',   shape=rect_wall.move( to = (W,0,H), by = (  0, 90)), front=0, back=1)  
        self.addWall(label='bottom',shape=rect_wall.move( to = (0,0,0), by = (  0,-90)), front=0, back=1)
