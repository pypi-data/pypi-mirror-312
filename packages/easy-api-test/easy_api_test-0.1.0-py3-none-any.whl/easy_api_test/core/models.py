import re
from typing import Any, Self, Sequence, Type, get_type_hints, Union, GenericAlias, _GenericAlias, get_origin, get_args
...
class Model(dict, metaclass=ModelMetaclass):
    __show__: str | Sequence[str] = None
    
    @classmethod
    def from_dict(cls, data: dict) -> Self:
        """
        将字典转换为模型对象，递归处理嵌套的字典
    ...
    @classmethod
    def from_list(cls, data: list) -> list[Self]:
        """
        将字典列表转换为模型对象列表
