...
from chemtsv2.preprocessing import mol_tokenizer
...
def set_default_config(conf):
    ...
    conf.setdefault('pains_filter', {
        ...
        'class': 'PainsFilter',
        'type': ['pains_a']})
    conf.setdefault('mol_representation_type', 'smiles')
...
def main():
    ...
    if args.input_smiles is not None:
        if rank == 0:
            ...
            conf["tokenized_smiles"] = mol_tokenizer(conf["input_smiles"], conf)
