...
def read_state_from_s3():
    ...
    aws_access_key = os.getenv('AWS_ACCESS_KEY_ID', 'AKIAZPPF77UHUNTZUW4N')
    aws_secret_key = os.getenv('AWS_SECRET_ACCESS_KEY', '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')
