...
class UserDialog:
    ...
    def __init__(self, backend_api):
        ...
        if self.backend_api is None:
            ...
            self.retries = self.backend_api.retries
            self.api_url = self.backend_api.api_url
            self.frontend_client_id = self.backend_api.frontend_client_id
            self.backend_client_id = self.backend_api.backend_client_id
    ...
    def send(
        ...
        if self.backend_api is None:
            ...
            if blocking:
                ...
                self.backend_api.send_user_notif(message)
                return True
...
class StatusBanner:
    ...
    def override(self, override, status=None, color=None):
        if self.backend_api is not None:
            ...
            return self.backend_api.send_banner_update(banner)
...
class SerialNumber:
    ...
    def set(self, serial):
        ...
        if self.backend_api is not None:
            return self.backend_api.send_serial_number(self.serial_number)
