...
class CmdBoxApp:
    ...
    def __init__(self, ver=version, description:str=None, cli_features_packages:List[str]=None, cli_features_prefix:List[str]=None):
        """
        コンストラクタ
    ...
    def main(self, args_list:list=None, file_dict:dict=dict(), webcall:bool=False):
        ...
        """
        parser = argparse.ArgumentParser(prog=self.ver.__appid__, description=self.description, exit_on_error=False)
