...
def get_code_snippet(snippet_name):
    """Fetch and print a specific code snippet."""
    if snippet_name in code_snippets:
        print(code_snippets[snippet_name])
    else:
        print(f"Code snippet for '{snippet_name}' not found.")