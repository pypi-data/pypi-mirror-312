...
class PwpEditorUI(PwpGui):
    ...
    def __init__(self, father: "PwpConfigurator", config: PwpConfig):
        ...
        self.verbosity_label = GuiLabel(self, self.frm, column=6, row=row,
    ...
    def __scenario_0p0(self):
        val_field: StringField = self.multi_level.all_lines['ssh-user']
    ...
    def __scenario3(self):
        ...
        self.root.after(5 * 1000, self.__run)
...
"""
        ...
        config_before_specials = config_delta.merge_ini(self.config.previous or self.config)

        # introduce again --home and --base, just like parse_for_dir
        self.config = self.pwp_main.parser.manage_cmdline_specials(config_before_specials,
                                                                   self.pwp_main.parser.cmd_line_args)
