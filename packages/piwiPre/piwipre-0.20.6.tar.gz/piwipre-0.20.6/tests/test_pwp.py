...
class PwpTester:
    ...
    def program_30(self):
        ...
        LOGGER.test_msg("we keep the ALBUM, and TRIAGE")
    ...
    def program_1007(self):
        ...
        # ------------------------------------------
        # Hand made scenario, just like 211, but with UI
        # TODO: make that scenario automatic
        # configure BASE with thumbnails useless
        # save BASE
        # copy tests/sources/PICTURES/Vendée/* in TRIAGE (i.e. WITHOUT the Vendée dir !)
        # run piwiPre
        # move 'tests/results/ALBUM/2023/2023-07-Juillet-02-TRIAGE' -> 'tests/results/ALBUM/2023/Chemin'
        # move 'tests/results/ALBUM/2023/2023-07-Juillet-04-TRIAGE' -> 'tests/results/ALBUM/2023/BBQ'
        # change config dir to CMDLINE
        # change verify-album to ALBUM/2023/BBQ
        # run piwiPre
        # change verify-album to ALBUM/2023/Chemin
        # run piwiPre
        # verify 'tests/results/ALBUM/2023/2023-07-Juillet-04-BBQ/2023-07-04-12h53-07-BBQ.jpg'
        #        'tests/results/ALBUM/2023/2023-07-Juillet-02-Chemin/2023-07-02-14h45-22-Chemin.jpg'
