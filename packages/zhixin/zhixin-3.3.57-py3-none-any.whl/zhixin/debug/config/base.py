...
from zhixin import fs, proc, util
from zhixin.compat import string_types
...
class DebugConfigBase:  # pylint: disable=too-many-instance-attributes
    ...
    def _configure_server(self):
        # user disabled server in zhixin.ini
    ...
    def reveal_patterns(self, source, recursive=True):
        ...
        patterns = {
            "ZHIXIN_CORE_DIR": self.project_config.get("zhixin", "core_dir"),
