...
from zhixin import __check_internet_hosts__, app, util
from zhixin.cache import ContentCache, cleanup_content_cache
from zhixin.compat import is_proxy_set
...
class InternetConnectionError(UserSideException):
    MESSAGE = (
        ...
        "ZhiXin needs the Internet connection to"
        " download dependent packages or to work with ZhiXin Account."
    )
