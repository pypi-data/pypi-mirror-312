...
from zhixin.device.monitor.filters.base import register_filters
from zhixin.device.monitor.terminal import get_available_filters, start_terminal
...
@click.option(
    "-e",
    "--environment",
    help="Load configuration from `zhixin.ini` and the specified environment",
)
