from zhixin import __registry_mirror_hosts__, fs
from zhixin.account.client import AccountClient, AccountError
        ...
        with open(archive_path, "rb") as fp:
            return self.fetch_json_data(
                ...
                headers={
                    ...
                    "X-ZX-Content-SHA256": fs.calculate_file_hashsum(
                        "sha256", archive_path
                    ),
                },
                data=fp,
