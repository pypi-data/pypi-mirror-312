...
from zhixin.device.list.util import list_serial_ports as get_serial_ports
from zhixin.fs import cd, load_json
...
def zxversion_to_intstr():
    """Legacy for  framework-zephyr/scripts/zhixin/zhixin-build-pre.py"""
