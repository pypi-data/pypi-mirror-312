...
<?fileVersion 4.0.0?><cproject storage_type_id="org.eclipse.cdt.core.XmlProjectDescriptionStorage">
				...
				<configuration artifactName="{{project_name}}" buildProperties="" description="" id="0.910961921" name="Default" parent="org.eclipse.cdt.build.core.prefbase.cfg">
					<folderInfo id="0.910961921." name="/" resourcePath="">
						<toolChain id="org.eclipse.cdt.build.core.prefbase.toolchain.952979152" name="No ToolChain" resourceTypeBasedDiscovery="false" superClass="org.eclipse.cdt.build.core.prefbase.toolchain">
							...
							<builder arguments="-f -c eclipse" cleanBuildTarget="run --target clean" command="zhixin" id="org.eclipse.cdt.build.core.settings.default.builder.1519453406" incrementalBuildTarget="run" keepEnvironmentInBuildfile="false" managedBuildOn="false" name="Gnu Make Builder" superClass="org.eclipse.cdt.build.core.settings.default.builder"/>
				...
				<configuration artifactName="mbed" buildProperties="" description="" id="0.910961921.1363900502" name="Debug" parent="org.eclipse.cdt.build.core.prefbase.cfg">
					<folderInfo id="0.910961921.1363900502." name="/" resourcePath="">
						<toolChain id="org.eclipse.cdt.build.core.prefbase.toolchain.2116690625" name="No ToolChain" resourceTypeBasedDiscovery="false" superClass="org.eclipse.cdt.build.core.prefbase.toolchain">
							...
							<builder arguments="-f -c eclipse debug" cleanBuildTarget="run --target clean" command="zhixin" enableCleanBuild="false" id="org.eclipse.cdt.build.core.settings.default.builder.985867833" incrementalBuildTarget="" keepEnvironmentInBuildfile="false" managedBuildOn="false" name="Gnu Make Builder" superClass="org.eclipse.cdt.build.core.settings.default.builder"/>
	...
	<storageModule moduleId="org.eclipse.cdt.make.core.buildtargets">
		<buildTargets>
			<target name="ZhiXin: Upload using Programmer" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
			...
			<target name="ZhiXin: Upload SPIFFS image" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Build" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Verbose Build" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Upload" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Verbose Upload" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Clean" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Test" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Remote" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Rebuild C/C++ Project Index" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: List Devices" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Update Project Libraries" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Update All" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
			...
			<target name="ZhiXin: Upgrade Core" path="" targetID="org.eclipse.cdt.build.MakeTargetBuilder">
				<buildCommand>zhixin</buildCommand>
				<buildArguments>-f -c eclipse</buildArguments>
