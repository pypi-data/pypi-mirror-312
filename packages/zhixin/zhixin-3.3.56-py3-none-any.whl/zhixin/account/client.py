...
from zhixin import __accounts_api__, app
from zhixin.exception import ZhixinException, UserSideException
from zhixin.http import HTTPClient, HTTPClientError


class AccountError(ZhixinException):
    MESSAGE = "{0}"


class AccountNotAuthorized(AccountError, UserSideException):
    MESSAGE = "You are not authorized! Please log in to ZhiXin Account."
...
class AccountClient(HTTPClient):  # pylint:disable=too-many-public-methods
    ...
    def fetch_authentication_token(self):
        if os.environ.get("ZHIXIN_AUTH_TOKEN"):
            return os.environ.get("ZHIXIN_AUTH_TOKEN")
