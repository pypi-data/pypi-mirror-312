...
@click.option(
    "--owner",
    help="ZX Account username (can be organization username). "
    "Default is set to a username of the authorized ZX Account",
)
@click.option(
    "--type",
    "typex",
