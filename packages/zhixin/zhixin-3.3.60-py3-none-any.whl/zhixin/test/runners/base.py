...
from zhixin.exception import ReturnErrorCode
from zhixin.platform.factory import PlatformFactory
from zhixin.test.exception import UnitTestSuiteError
from zhixin.test.result import TestCase, TestStatus
from zhixin.test.runners.readers.native import NativeTestOutputReader
from zhixin.test.runners.readers.serial import SerialTestOutputReader
...
class TestRunnerBase:
    ...
    def stage_building(self):
        ...
        try:
            ...
            raise UnitTestSuiteError(
                ...
                "Use `zx test -vvv` option to enable verbose output."
            ) from exc
    ...
    def run_project_targets(self, targets):
        ...
        from zhixin.run.cli import cli as run_cmd
    ...
    def configure_build_env(self, env):
        ...
        Called in "builder/tools/zxtest" tool
        """
        return env
