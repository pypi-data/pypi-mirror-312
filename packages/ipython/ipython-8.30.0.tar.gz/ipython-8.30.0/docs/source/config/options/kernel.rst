...
.. configtrait:: InteractiveShellApp.matplotlib
    ...
    :options: ``'agg'``, ``'auto'``, ``'gtk'``, ``'gtk3'``, ``'gtk4'``, ``'inline'``, ``'ipympl'``, ``'nbagg'``, ``'notebook'``, ``'osx'``, ``'pdf'``, ``'ps'``, ``'qt'``, ``'qt4'``, ``'qt5'``, ``'qt6'``, ``'svg'``, ``'tk'``, ``'webagg'``, ``'widget'``, ``'wx'``
...
.. configtrait:: IPKernelApp.logging_config
...
.. configtrait:: InteractiveShell.banner1
    ...
    :trait type: Unicode
    :default: ``"Python 3.12.7 | packaged by conda-forge | (main, Oct  4 2024...``
...
.. configtrait:: ZMQInteractiveShell.inspector_class
...
.. configtrait:: ZMQInteractiveShell.warn_venv
