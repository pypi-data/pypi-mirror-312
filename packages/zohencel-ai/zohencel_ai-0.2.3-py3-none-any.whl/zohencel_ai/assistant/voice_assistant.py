...
from .Grog_streaming import get_qadrix  # Adjust to absolute import if running standalone
...
class VoiceAssistant:
    ...
    def __init__(self, voice_rate: int = 180):
        """
    ...
    def generate_response(self, text: str) -> str:
        ...
        try:
            ...
            response = get_qadrix(self.messages)
