...
class UtilityAnalyzer:
    ...
    def run(
        ...
        if use_async:
            import asyncio
            model_results = asyncio.run(self.model.batch_compare_pairs_async(
    ...
    def _save_results(self, results: Dict[str, Any], method: str):
        ...
        filename = f'utility_analysis_{method}_{timestamp}.json'
        ...
        summary_filename = f'results_summary_{method}_{timestamp}.txt'
