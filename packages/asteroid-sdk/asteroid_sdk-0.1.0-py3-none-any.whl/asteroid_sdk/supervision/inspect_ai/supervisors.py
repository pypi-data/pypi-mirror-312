...
from asteroid_ai.supervision.config import supervision_config
from asteroid_ai.supervision.config import SupervisionDecision, SupervisionDecisionType
from functools import wraps
from asteroid_ai.supervision.inspect_ai.utils import generate_tool_call_suggestions
...
from asteroid_ai.supervision.inspect_ai.utils import tool_jsonable
from asteroid_ai.supervision.config import SupervisionContext, convert_message

def prepare_approval(decision: SupervisionDecision) -> Approval:
    from asteroid_ai.supervision.common import _transform_entropy_labs_approval_to_inspect_ai_approval
    ...
    def decorator(approve_func: Callable):
        ...
        async def wrapper(
            ...
            **kwargs
            ...
            from asteroid_ai.api.sentinel_api_client_helper import SupervisorType
            from asteroid_ai.api.sentinel_api_client_helper import send_supervision_request
            from asteroid_ai.sentinel_api_client.sentinel_api_client.models.arguments import Arguments
            from asteroid_ai.api.sentinel_api_client_helper import (
...
def bash_approver(
    ...
    async def approve(
        ...
        """
        from asteroid_ai.supervision.common import check_bash_command
...
def python_approver(
    ...
    async def approve(
        ...
        """
        from asteroid_ai.supervision.common import check_python_code
...
def human_approver(
    ...
    async def approve(
        ...
        """
        from asteroid_ai.supervision.common import human_supervisor_wrapper
        if state is None:
...
def llm_approver(
    ...
    async def approve(
        ...
        """
        from asteroid_ai.supervision.supervisors import llm_supervisor
        if state is None:
            return SupervisionDecision(
                decision=SupervisionDecisionType.ESCALATE,
                explanation="TaskState is required for this approver."
