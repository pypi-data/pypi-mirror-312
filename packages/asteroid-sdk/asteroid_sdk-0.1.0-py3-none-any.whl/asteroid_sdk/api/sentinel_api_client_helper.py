...
from asteroid_ai.supervision.inspect_ai._config import FRONTEND_URL
from asteroid_ai.supervision.supervisors import auto_approve_supervisor
from rich.console import Console
from inspect_ai.util._console import input_screen
import time
from asteroid_ai.sentinel_api_client.sentinel_api_client.client import Client
from typing import Union
from uuid import UUID

from asteroid_ai.sentinel_api_client.sentinel_api_client.api.run.update_run_status import sync_detailed as update_run_status_sync_detailed
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.run.update_run_result import sync_detailed as update_run_result_sync_detailed
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.run.get_run import sync_detailed as get_run_sync_detailed
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.status import Status
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.update_run_result_body import UpdateRunResultBody

from asteroid_ai.sentinel_api_client.sentinel_api_client.api.supervision.get_supervision_request_status import (
    sync_detailed as get_supervision_status_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.supervision.get_supervision_result import (
    sync_detailed as get_supervision_result_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.supervision_result import (
    SupervisionResult
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.status import Status
from asteroid_ai.sentinel_api_client.sentinel_api_client.types import UNSET
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.supervisor_type import (
    SupervisorType,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.request_group.get_request_group import (
    sync_detailed as get_request_group_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.tool.create_run_tool import (
    sync_detailed as create_tool_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.supervisor.create_supervisor import (
    sync_detailed as create_supervisor_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.supervisor import Supervisor
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.supervisor.create_tool_supervisor_chains import (
    sync_detailed as create_tool_supervisor_chains_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.run.update_run_status import (
    sync_detailed as update_run_status_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.task.create_task import (
    sync_detailed as create_task_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.run.update_run_result import (
    sync_detailed as update_run_result_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.supervisor.get_tool_supervisor_chains import (
    sync_detailed as get_tool_supervisor_chains_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.request_group.create_tool_request_group import (
    sync_detailed as create_tool_request_group_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.request_group.get_run_request_groups import (
    sync_detailed as get_request_groups_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.request_group.get_request_group_status import (
    sync_detailed as get_request_group_status_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.supervision.create_supervision_request import (
    sync_detailed as create_supervision_request_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.supervision.create_supervision_result import (
    sync_detailed as create_supervision_result_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.request_group.create_tool_request import (
    sync_detailed as create_tool_request_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.request_group.get_request_group_status import (
    sync_detailed as get_request_group_status_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.request_group.get_tool_request import (
    sync_detailed as get_tool_request_sync_detailed,
)

from asteroid_ai.sentinel_api_client.sentinel_api_client.models.update_run_result_body import (
    UpdateRunResultBody
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.decision import Decision
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.tool_attributes import (
    ToolAttributes,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.create_task_body import CreateTaskBody
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.tool_request import (
    ToolRequest,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.tool_request_group import (
    ToolRequestGroup,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.run import Run 
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.create_run_tool_body import (
    CreateRunToolBody,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.create_run_tool_body_attributes import (
    CreateRunToolBodyAttributes,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.supervision_request import (
    SupervisionRequest,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.supervisor_attributes import (
    SupervisorAttributes,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.chain_request import (
    ChainRequest,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.arguments import Arguments
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.supervisor_chain import SupervisorChain
from datetime import datetime, timezone
import inspect
from asteroid_ai.utils.utils import get_function_code
from typing import List, Optional, Any, Callable
from uuid import UUID, uuid4
from asteroid_ai.sentinel_api_client.sentinel_api_client.client import Client
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.project.create_project import (
    sync_detailed as create_project_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.api.run.create_run import (
    sync_detailed as create_run_sync_detailed,
)
from asteroid_ai.sentinel_api_client.sentinel_api_client.models.create_project_body import CreateProjectBody
import logging
from asteroid_ai.supervision.config import supervision_config, SupervisionContext
...
def get_sample_result(sample_id: str, timeout: Optional[int] = 300) -> str:
    ...
    """
    from asteroid_ai.supervision.config import get_supervision_config
