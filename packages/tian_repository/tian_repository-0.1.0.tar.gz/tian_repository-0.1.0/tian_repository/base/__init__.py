...
from tian_drivers import Driver
from tian_core.entity import Entity
import time
...
class AbstractRepository(ABC):
    ...
    def fetch(self, query: AnyStr, **kwargs) -> Any:
        ...
        :return Any: Fetched records
        """
        
        return self.driver.query(query, **kwargs)
    
    def total(self, **kwargs) -> int:
        """Return total number of records according to passed filters."""
        return 0