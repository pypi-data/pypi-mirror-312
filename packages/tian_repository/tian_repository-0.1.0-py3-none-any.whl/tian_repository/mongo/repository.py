...
from tian_drivers.src.mongo import Mongo, MongoAction, MongoActionType
from .common import *
class MongoRepository(AbstractRepository):
    ...
    def find_one(self, **kwargs) -> Any:
        ...
        """
        print(self.__collection, self.entity)
        # check_builder_requirements('find_one', self.__collection, self.entity)
    ...
    def execute(self, sql: AnyStr, *args):
        pass
    ...
    def find_many(self, **kwargs) -> List[Any]:
        ...
        # check_builder_requirements('find_many', self.__collection, self.entity)
    ...
    def insert_one(self, record: Entity, return_id: bool = False) -> Any:
        ...
        :return Any: List of records found by query.
        """
        # check_builder_requirements('insert_one', self.__collection, self.entity)
        data = {key: handle_extra_types(value) for key, value in record.to_dict().items()}
        ...
        return result.inserted_id if return_id else None
