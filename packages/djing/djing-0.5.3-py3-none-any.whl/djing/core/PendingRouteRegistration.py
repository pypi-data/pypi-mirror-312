...
from djing.core.Http.Controllers.pages.DashboardController import DashoardController
...
class PendingRouteRegistration:
    ...
    def __load_auth_routes(self, router: Router):
        ...
        Route.get("dashboards/:name", DashoardController).name("dashboard.custom")
