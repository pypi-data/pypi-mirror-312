    ...
    def render(self):
        ...
        for step in self.steps:
            ...
            if (self.mode == "Optimization"):
                ...
                CTkButton(button_container, width=30, text=None, image=expand_image if not step['open'] else collapse_image, command=expand_func).grid(row=0, column=0, padx=(10, 15), pady=(10, 10), sticky="nsew")
                CTkButton(button_container, width=30, text=None, image=override_image, command=open_override_window).grid(row=0, column=1, padx=(10, 10), pady=(10, 10), sticky="nsew")
                ...
                CTkButton(button_container, width=30, text=None, image=down_image, state="disabled" if index==(len(self.steps)-1) else "normal", fg_color="gray" if index==(len(self.steps)-1) else None, command=down_func).grid(row=0, column=3, padx=(10, 15), pady=(10, 10), sticky="nsew")
