...
from typing import Any, AnyStr, Dict, NoReturn, Optional, Set, Union, List

import pymongo
from pymongo.collection import Cursor
from pymongo.results import (DeleteResult, InsertManyResult, InsertOneResult, UpdateResult)
from tian_core.error import BuilderError, DriverConfigError, DriverExecutionError, QueryError
...
class Mongo(Driver):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.__build_connection(url, user, pwd, host, port, database, server_api=ServerApi('1'), **kwargs)
...
# MONGODB_URI = 'mongodb+srv://myAtlasDBUser:myatlas-001@myatlasclusteredu.obiqc7k.mongodb.net'
