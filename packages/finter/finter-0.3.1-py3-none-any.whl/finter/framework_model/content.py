...
class Loader(metaclass=ABCMeta):
    ...
    @staticmethod
    def _slice_dataframe_by_time(cm_name: str, start: int, end: int, columns: list) -> pd.DataFrame:
...
class LoaderTemplate(Loader):
    ...
    def get_df(self, start: int, end: int, fill_nan=True, *args, **kwargs) -> pd.DataFrame:
