from iccore.version_control import gitlab

def test_gitlab_models():

    asset_link = gitlab.GitlabReleaseAssetLink(name="my_asset",
    ...
    release_manifest = gitlab.GitlabReleaseManifest(project_version="1.2.3",
                                                    base_url="http://example.com",
                                                    assets = assets)
