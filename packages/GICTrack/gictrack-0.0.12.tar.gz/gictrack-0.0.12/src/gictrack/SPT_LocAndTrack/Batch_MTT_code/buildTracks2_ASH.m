...
% Modified from M.Mir to take 3d image matrix width and height directly as function input,
% rather than reading it in as a TIFF-stack. Also removed the waitbar. 

function data=buildTracks2_ASH(dir_path, Filename, data, impars, locpars, trackpars, ctrsN, imgs_3d_double)
% Anders Sejr Hansen
% August 16, 2016
...
%         writematrix(vertcat(data.tr{:}), [dir_path, Filename, '_table.txt'], 'delimiter', '\t');
