...
input_path=('C:\Users\Yeuyo\Documents\MATLAB\files for yew\');
output_path=('C:\Users\Yeuyo\Documents\MATLAB\files for yew\output\');
...
MaxExpectedD = 3; % The maximal expected diffusion constant for tracking in units of um^2/s;
...
locpars.wn=7; %detection box in pixels
...
% addpath('C:\Users\Matt Graus\Documents\MATLAB\SPT_LocAndTrack-master\');
