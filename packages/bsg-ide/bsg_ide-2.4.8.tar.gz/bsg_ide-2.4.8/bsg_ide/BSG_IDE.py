...
#------------------------------------------------------------------------------
    ...
    def save_current_slide(self):
        """Save current slide data with bounds checking"""
        ...
        if self.current_slide_index >= 0:
            # If index is beyond list bounds, extend list
            while len(self.slides) <= self.current_slide_index:
                self.slides.append({
                    'title': '',
                    'media': '',
                    'content': [],
            ...
            # Now safely save the current slide
