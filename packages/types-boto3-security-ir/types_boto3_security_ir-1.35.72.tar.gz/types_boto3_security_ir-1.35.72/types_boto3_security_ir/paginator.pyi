...
class ListCaseEditsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_security_ir/paginators/#listcaseeditspaginator)
    """
    def paginate(
...
class ListCasesPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_security_ir/paginators/#listcasespaginator)
    """
    def paginate(
...
class ListCommentsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_security_ir/paginators/#listcommentspaginator)
    """
    def paginate(
...
class ListMembershipsPaginator(Paginator):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_security_ir/paginators/#listmembershipspaginator)
    """
    def paginate(
