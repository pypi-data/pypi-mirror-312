...
from visdom import _SendReturn, pytorch_wrap
import visdom
...
class VisWindow(visdom.Visdom):
    ...
    def line(self, Y: visdom.Any, X: visdom.Any | None = ..., win: str | None = ..., env: str | None = ..., update: str | None = ..., name: str | None = ..., opts: visdom.Mapping[str, visdom.Any] | None = ..., legend=None, xlabel=None, ylabel=None, title=None) -> str:
        if opts is None:
            opts = {}
        ...
        return super().line(Y, X, win, env, update, name, opts)
...
class ScriptVisServer:
    ...
    def __init__(self, env, port=8097):
        ...
        assert isinstance(env, ScriptFileSaver)
        self.port = port
        self.env = env
        self.windows = {}
