...
class File:
    ...
    def fetch(self, range1: str | None = None, range2: str | None = None, normalization: str | None = None, count_type: str = 'int', join: bool = False, query_type: str = 'UCSC') -> PixelSelector:
...
class PixelSelector:
    ...
    @overload
    def __init__(self, selector: "std::shared_ptr<hictk::cooler::PixelSelector const >", type: str, join: bool) -> None: ...

    @overload
    def __init__(self, selector: "std::shared_ptr<hictk::hic::PixelSelector const >", type: str, join: bool) -> None: ...

    @overload
    def __init__(self, selector: "std::shared_ptr<hictk::hic::PixelSelectorAll const >", type: str, join: bool) -> None: ...
