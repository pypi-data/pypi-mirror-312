...
class PDFDto(BaseModel):
    ...
    PDFDto
    """ # noqa: E501
    reference_id: Optional[StrictStr] = Field(default=None, description="Internal reference identifier")
    template_id: Optional[StrictStr] = Field(default=None, description="Targeting template identifier")
    download_url: Optional[StrictStr] = Field(default=None, description="URL of generated document")
    expires: Optional[datetime] = Field(default=None, description="Expiration date")
    created_at: Optional[datetime] = Field(default=None, description="Creation date")
    __properties: ClassVar[List[str]] = ["reference_id", "template_id", "download_url", "expires", "created_at"]
