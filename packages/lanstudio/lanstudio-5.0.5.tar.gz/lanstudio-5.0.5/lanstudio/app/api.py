...
from lanstudio.app.utils import events, api as api_utils

from flask import Blueprint

from lanstudio.app.blueprints.assets import blueprint as assets_blueprint
from lanstudio.app.blueprints.auth import blueprint as auth_blueprint
from lanstudio.app.blueprints.breakdown import blueprint as breakdown_blueprint
from lanstudio.app.blueprints.comments import blueprint as comments_blueprint
from lanstudio.app.blueprints.crud import blueprint as crud_blueprint
from lanstudio.app.blueprints.entities import blueprint as entities_blueprint
from lanstudio.app.blueprints.events import blueprint as events_blueprint
from lanstudio.app.blueprints.export import blueprint as export_blueprint
from lanstudio.app.blueprints.files import blueprint as files_blueprint
from lanstudio.app.blueprints.index import blueprint as index_blueprint
from lanstudio.app.blueprints.search import blueprint as search_blueprint
from lanstudio.app.blueprints.news import blueprint as news_blueprint
from lanstudio.app.blueprints.persons import blueprint as persons_blueprint
from lanstudio.app.blueprints.playlists import blueprint as playlists_blueprint
from lanstudio.app.blueprints.projects import blueprint as projects_blueprint
from lanstudio.app.blueprints.previews import blueprint as previews_blueprint
from lanstudio.app.blueprints.source import blueprint as import_blueprint
from lanstudio.app.blueprints.shots import blueprint as shots_blueprint
from lanstudio.app.blueprints.tasks import blueprint as tasks_blueprint
from lanstudio.app.blueprints.user import blueprint as user_blueprint
from lanstudio.app.blueprints.edits import blueprint as edits_blueprint
