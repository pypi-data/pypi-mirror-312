...
from lanstudio.app import config, swagger
...
from lanstudio.app.utils import cache, fs, logs, monitoring
from lanstudio.app.utils.flask import ParsedUserAgent, ORJSONProvider
...
def configure_auth():
    from lanstudio.app.services import persons_service
