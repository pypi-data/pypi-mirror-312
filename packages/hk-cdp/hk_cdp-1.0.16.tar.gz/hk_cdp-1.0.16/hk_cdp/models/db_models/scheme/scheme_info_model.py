...
class SchemeInfo:
    ...
    def get_field_list(cls):
        return [
            'id', 'guid', 'business_id', 'scheme_name', 'level_rule_type',
            'include_platforms', 'include_stores', 'level_num', 'operate_user_id',
            'operate_user_name', 'extend_info', 'create_date', 'modify_date'
        ]
