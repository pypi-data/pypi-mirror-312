...
from modules.basic.models import lr_scheduler as lr_scheduler
from modules.basic.utils import get_root_logger
from modules.basic.utils.dist_util import master_only
...
class BaseModel:
    ...
    @master_only
    def save_network(self, net, net_label, current_iter, period, param_key="params"):
        """Save networks.
        ...
        if current_iter == -1:
            current_iter = "latest"
        save_filename = f"{net_label}_{current_iter}_{period}.pth"
