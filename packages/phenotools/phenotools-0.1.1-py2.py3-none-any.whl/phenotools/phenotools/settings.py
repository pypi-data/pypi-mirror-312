"""
Django settings for phenotools project.
...
WSGI_APPLICATION = "phenotools.wsgi.application"
# ASGI_APPLICATION = "phenotools.routing.application"
