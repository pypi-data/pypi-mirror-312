...
from mrsimulator.utils.euler_angles import _angle_phase_to_euler_angles
...
def combine_mixing_queries(queries: list):
    ...
    # Convert to a list of (alpha, beta, gamma) angle tuples
    euler_angles = [_angle_phase_to_euler_angles(**query) for query in queries]

    return combine_euler_angles(euler_angles)
