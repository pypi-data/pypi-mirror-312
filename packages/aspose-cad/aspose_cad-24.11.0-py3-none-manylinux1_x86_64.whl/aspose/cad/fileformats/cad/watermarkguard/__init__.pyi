...
class CadWatermarkGuardService(aspose.cad.watermarkguard.IWatermarkGuardService):
    ...
    def embed_text(self, text : str) -> bool:
        '''Embeds the text.
    ...
    def embed_image(self, stream : io.RawIOBase) -> bool:
        '''Embeds the image.
        
        :param stream: The stream to the image.
        :returns: The success of operation.'''
        ...
    ...
    def validate_image(self, stream : io.RawIOBase) -> bool:
        '''Validates the image.
    ...
    def visit_entity(self, entity : aspose.cad.IDrawingEntity) -> None:
